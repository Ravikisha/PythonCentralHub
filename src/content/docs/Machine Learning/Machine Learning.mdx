...
description: A complete, practical Machine Learning roadmap—from foundations to deployment.
sidebar:
  order: 247
---
...
Machine Learning (ML) is the discipline of building **systems that learn patterns from data** so they can make predictions or decisions without being explicitly programmed for every rule.

In this module, you’ll learn:

- the core ML vocabulary and mental models
- how ML differs from traditional programming
- how to set up a modern ML environment in Python
- the full ML lifecycle (data → model → evaluation → deployment)

## How this module is structured

- **Phase 1: The ML Foundation** gives you the big picture and the core language of ML.
- Later phases move into preprocessing, supervised/unsupervised learning, deep learning, NLP, and deployment (MLOps).

## Prerequisites

- Python basics (functions, lists/dicts, modules)
- Basic math intuition (high-school algebra). You don’t need heavy calculus to start.

## A simple ML example

Traditional programming: you write rules.

ML: you provide examples and let the model learn the rules.
...
Start with **Phase 1** and go page by page.
