---
title: Managing Paths with pathlib
description: Use pathlib.Path for readable, cross-platform path handling.
sidebar:
  order: 145
---
...
```python title="pathlib_basics.py" showLineNumbers{1}
...
```python title="pathlib_read_write.py" showLineNumbers{1}
from pathlib import Path
