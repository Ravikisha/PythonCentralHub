---
title: Generating Automated Reports
description: Combine CSV/Excel/PDF/Docx workflows into one repeatable reporting pipeline.
sidebar:
  order: 158
---
...
```python title="csv_to_excel.py" showLineNumbers{1}
import csv
