---
title: Working with Excel - openpyxl Basics
description: Read and write Excel .xlsx files with openpyxl - cells, sheets, rows, and formatting basics.
sidebar:
  order: 151
---
...
```python title="excel_create.py" showLineNumbers{1}
...
```python title="excel_read.py" showLineNumbers{1}
