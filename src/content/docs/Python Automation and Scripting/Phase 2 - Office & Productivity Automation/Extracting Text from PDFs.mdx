...
description: Extract text from PDF files and learn when OCR is needed.
sidebar:
  order: 155
---
...
```python title="pdf_extract_text.py" showLineNumbers{1}
...
If `extract_text()` returns empty or garbage:
