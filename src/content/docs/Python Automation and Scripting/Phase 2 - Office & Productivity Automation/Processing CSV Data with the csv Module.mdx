---
title: Processing CSV Data with the csv Module
description: Read, write, and transform CSV files using Python’s built-in csv module.
sidebar:
  order: 153
---
...
```python title="csv_read.py" showLineNumbers{1}
import csv
...
```python title="csv_write.py" showLineNumbers{1}
import csv
