...
description: Run Python automation scripts reliably from the shell, using venvs and predictable working directories.
sidebar:
  order: 183
---
...
```python title="base_dir.py" showLineNumbers{1}
