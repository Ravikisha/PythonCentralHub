---
title: Parameterized Testing - Running Tests with Multiple Data Sets
description: Use pytest.mark.parametrize to test many cases with one test function.
sidebar:
  order: 217
---
...
```python title="test_parametrize.py" showLineNumbers{1}
import pytest
...
```python title="test_parametrize_ids.py" showLineNumbers{1}
import pytest
