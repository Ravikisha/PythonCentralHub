---
title: Testing REST APIs with the requests Library
description: Write API tests using requests with timeouts, sessions, and JSON contract assertions.
sidebar:
  order: 223
---
...
```python title="api_test_requests.py" showLineNumbers{1}
import requests
...
```python title="api_session.py" showLineNumbers{1}
import requests
