---
title: Real-Time Topic Modeling
description: A Python application for modeling topics in real-time using machine learning, featuring data preprocessing, model training, and a CLI interface.
sidebar:
    order: 110
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/real_time_topic_modeling.py
      icon: github
      variant: primary
---
...
```python title="real_time_topic_modeling.py" showLineNumbers{1}
import pandas as pd
