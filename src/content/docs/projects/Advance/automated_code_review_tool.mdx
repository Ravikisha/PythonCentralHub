...
description: A Python application for automated code review, featuring static analysis, style checking, and a CLI interface.
sidebar:
    order: 30
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/automated_code_review_tool.py
      icon: github
      variant: primary
---
...
```python title="automated_code_review_tool.py" showLineNumbers{1}
import subprocess
```
