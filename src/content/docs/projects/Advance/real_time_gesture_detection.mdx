...
description: A Python application for detecting gestures in real-time using computer vision, featuring image processing, model training, and a CLI interface.
sidebar:
    order: 90
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/real_time_gesture_detection.py
      icon: github
      variant: primary
---
...
## Getting Started
#### Create a Project
1. Create a folder named `real-time-gesture-detection`.
2. Open the folder in your code editor or IDE.
3. Create a file named `real_time_gesture_detection.py`.
4. Copy the code below into your file.

## Write the Code
<FileCode file="projects/advance/real_time_gesture_detection.py" lang="python" title="Real-Time Gesture Detection" />

## Example Usage
```bash title="Run gesture detection" showLineNumbers{1}
...
```python title="real_time_gesture_detection.py" showLineNumbers{1}
import cv2
import numpy as np
from sklearn.ensemble import RandomForestClassifier
```

2. **Gesture Detection and Image Processing Functions**
```python title="real_time_gesture_detection.py" showLineNumbers{1}
