---
title: Real-Time Text Classification
description: A Python application for classifying text in real-time using machine learning, featuring data preprocessing, model training, and a CLI interface.
sidebar:
    order: 112
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/real_time_text_classification.py
      icon: github
      variant: primary
---
...
```python title="real_time_text_classification.py" showLineNumbers{1}
import pandas as pd
import nltk
