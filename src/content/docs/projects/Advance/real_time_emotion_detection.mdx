...
description: A Python application for detecting emotions in real-time using computer vision, featuring image processing, model training, and a CLI interface.
sidebar:
    order: 89
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/real_time_emotion_detection.py
      icon: github
      variant: primary
---
...
## Write the Code
<FileCode file="projects/advance/real_time_emotion_detection.py" lang="python" title="Real-Time Emotion Detection" />

## Example Usage
```bash title="Run emotion detection" showLineNumbers{1}
...
```python title="real_time_emotion_detection.py" showLineNumbers{1}
import cv2
import numpy as np
from sklearn.ensemble import RandomForestClassifier
```

2. **Emotion Detection and Image Processing Functions**
```python title="real_time_emotion_detection.py" showLineNumbers{1}
