...
description: A Python application for detecting vehicles in real-time using computer vision, featuring image processing, model training, and a CLI interface.
sidebar:
    order: 88
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/real_time_vehicle_detection.py
      icon: github
      variant: primary
---
...
```python title="real_time_vehicle_detection.py" showLineNumbers{1}
import cv2
import numpy as np
from sklearn.ensemble import RandomForestClassifier
```

2. **Vehicle Detection and Image Processing Functions**
```python title="real_time_vehicle_detection.py" showLineNumbers{1}
