---
title: Real-Time Video Extraction
description: A Python application for extracting videos in real-time using machine learning, featuring data preprocessing, model training, and a CLI interface.
sidebar:
    order: 124
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/real_time_video_extraction.py
      icon: github
      variant: primary
---
...
## Write the Code
<FileCode file="projects/advance/real_time_video_extraction.py" lang="python" title="Real-Time Video Extraction" />

## Example Usage
```bash title="Run video extraction" showLineNumbers{1}
...
```python title="real_time_video_extraction.py" showLineNumbers{1}
import pandas as pd
import cv2
