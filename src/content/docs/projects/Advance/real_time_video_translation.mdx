...
description: A Python application for translating videos in real-time using machine learning, featuring data preprocessing, model training, and a CLI interface.
sidebar:
    order: 123
hero:
  actions:
    - text: View on GitHub
      link: https://github.com/Ravikisha/PythonCentralHub/blob/main/projects/advance/real_time_video_translation.py
      icon: github
      variant: primary
---
...
```python title="real_time_video_translation.py" showLineNumbers{1}
import pandas as pd
import cv2
