...
### Exercise 1 – readline() vs readlines()

<DataCampExercise
  lang="python"
  hint={`readline() reads one line; readlines() reads all lines as a list.`}
  code={`# Task: Exercise 1 – readline() vs readlines()
...
# with open("/tmp/multi.txt", "w") as f:
...
# ──────────────────────────────────────────────────────────────`}
  solution={`with open("/tmp/multi.txt", "w") as f:
    f.write("first\nsecond\nthird")
with open("/tmp/multi.txt", "r") as f:
    print(f.readline().strip())
    print(f.readline().strip())`}
  sct={`test_output_contains("first")
test_output_contains("second")
success_msg("readline() works!")`}
  height={190}
/>

### Exercise 2 – tell() and seek()

<DataCampExercise
  lang="python"
  hint={`tell() returns current position; seek() moves to a position.`}
  code={`# Task: Exercise 2 – tell() and seek()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# replace the comment above with working code
    ...
    # replace the comment above with working code
    # Step: Call print() with the right argument(s).
    # Example structure: print("Position:", f.tell())
    print(___)  # replace ___ with the correct expression
    # Step: Write the required code here.
    # f.seek(0)
    # replace the comment above with working code
    # Step: Call print() with the right argument(s).
    # Example structure: print(f.read())
    print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`with open("/tmp/seek.txt", "w") as f:
    f.write("Hello World")
with open("/tmp/seek.txt", "r") as f:
    f.read(5)
    ...
    f.seek(0)
    print(f.read())`}
  sct={`test_output_contains("Position: 5")
test_output_contains("Hello World")
success_msg("tell() and seek() work!")`}
  height={210}
/>

### Exercise 3 – writelines()

<DataCampExercise
  lang="python"
  hint={`Use writelines() to write a list of strings to a file.`}
  code={`# Task: Exercise 3 – writelines()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a list) to 'lines'.
...
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Write the required code here.
# with open("/tmp/fruits.txt", "r") as f:
# replace the comment above with working code
    # Step: Call print() with the right argument(s).
    # Example structure: print(f.read())
    print(___)  # replace ___ with the correct expression
