...
## Try it: OS Methods Exercises

### Exercise 1 – List Directory

<DataCampExercise
  lang="python"
  hint={`Use os.listdir() to list files and folders in a directory.`}
  code={`# Task: Exercise 1 – List Directory
...
### Exercise 2 – Get and Change Directory

<DataCampExercise
  lang="python"
  hint={`Use os.getcwd() to get the current directory.`}
  code={`# Task: Exercise 2 – Get and Change Directory
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Above import is provided -- understand what it brings in.
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value to 'cwd'.
cwd = ___  # replace ___ with the correct value
# Hint: Use os.getcwd() to get the current directory.
# Step: Call print() with the right argument(s).
# Example structure: print("CWD type:", type(cwd).__name__)
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Is string:", isinstance(cwd, str))
print(___)  # replace ___ with the correct expression
...
# ──────────────────────────────────────────────────────────────`}
  solution={`import os
cwd = os.getcwd()
print("CWD type:", type(cwd).__name__)
print("Is string:", isinstance(cwd, str))`}
  sct={`test_output_contains("Is string: True")
success_msg("os.getcwd() works!")`}
  height={140}
/>

### Exercise 3 – Path Join

<DataCampExercise
  lang="python"
  hint={`Use os.path.join() to build paths safely across platforms.`}
  code={`# Task: Exercise 3 – Path Join
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Above import is provided -- understand what it brings in.
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value to 'path'.
path = ___  # replace ___ with the correct value
# Hint: Use os.path.join() to build paths safely across platforms.
# Step: Call print() with the right argument(s).
# Example structure: print(path)
print(___)  # replace ___ with the correct expression
...
# ──────────────────────────────────────────────────────────────`}
  solution={`import os
path = os.path.join("/tmp", "folder", "file.txt")
print(path)`}
  sct={`test_output_contains("/tmp/folder/file.txt")
success_msg("os.path.join() works!")`}
  height={130}
/>
