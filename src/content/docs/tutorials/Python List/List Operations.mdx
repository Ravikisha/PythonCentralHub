...
## Try it: List Operations Exercises

### Exercise 1 – Concatenate Lists

<DataCampExercise
  lang="python"
  hint={`Use + to join two lists into one.`}
  code={`# Task: Exercise 1 – Concatenate Lists
...
# Step: Assign the correct value (a list) to 'a'.
a = ___  # replace ___ with the correct value
# Hint: Use + to join two lists into one.
# Step: Assign the correct value (a list) to 'b'.
...
success_msg("List concatenation works!")`}
  height={130}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use a list comprehension to create a list of squares: [x**2 for x in range(1, 6)]`}
  code={`# Task: Exercise 2 – List Comprehension
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: List comprehension: [expression for item in iterable if condition]
# Step: Assign the correct value (a list) to 'squares'.
squares = ___  # replace ___ with the correct value
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print(squares)
print(___)  # replace ___ with the correct expression
...
print(squares)`}
  sct={`test_output_contains("1, 4, 9, 16, 25")
success_msg("List comprehension works!")`}
  height={120}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use [x for x in nums if x % 2 == 0] to get only even numbers.`}
  code={`# Task: Exercise 3 – Filter with List Comprehension
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a list) to 'evens'.
evens = ___  # replace ___ with the correct value
# Hint: Use [x for x in nums if x % 2 == 0] to get only even numbers.
# Step: Call print() with the right argument(s).
# Example structure: print(evens)
print(___)  # replace ___ with the correct expression
...
success_msg("List comprehension filtering works!")`}
  height={140}
/>
