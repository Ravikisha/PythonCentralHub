...
<DataCampExercise
  lang="python"
  hint={`Create a list of 3 fruits and print it.`}
  code={`# Task: Exercise 1 – Create and Print a List
...
success_msg("List created successfully!")`}
  height={120}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use len() for length and index to access elements.`}
  code={`# Task: Exercise 2 – List Length and Indexing
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Step: Call print() with the right argument(s).
# Example structure: print("First:", nums[0])
print(___)  # replace ___ with the correct expression
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print("Last:", nums[-1])
print(___)  # replace ___ with the correct expression
...
test_output_contains("First: 10")
test_output_contains("Last: 50")
success_msg("List indexing works!")`}
  height={170}
/>
...
<DataCampExercise
  lang="python"
  hint={`Access matrix[1][2] to get the element in row 2, column 3.`}
  code={`# Task: Exercise 3 – Nested List
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a list) to 'matrix'.
matrix = ___  # replace ___ with the correct value
# Hint: Access matrix[1][2] to get the element in row 2, column 3.
# Step: Call print() with the right argument(s).
# Example structure: print(matrix[1][2])
print(___)  # replace ___ with the correct expression
...
success_msg("Nested list access works!")`}
  height={130}
/>
