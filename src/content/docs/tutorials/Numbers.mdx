...
<DataCampExercise
  lang="python"
  hint={`Use +, -, *, //, % operators on integers.`}
  code={`# Task: Exercise 1 – Integer Arithmetic
...
# Example structure: print("Sum:", a + b)
print(___)  # replace ___ with the correct expression
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print("Difference:", a - b)
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print("Product:", a * b)
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print("Floor division:", a // b)
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print("Remainder:", a % b)
print(___)  # replace ___ with the correct expression
...
print("Remainder:", a % b)`}
  sct={`test_output_contains("Sum: 22")
test_output_contains("Product: 85")
test_output_contains("Remainder: 2")
success_msg("Integer arithmetic mastered!")`}
  height={200}
/>

### Exercise 2 – Float Operations

<DataCampExercise
  lang="python"
  hint={`Use float variables and print results. Try round() to control decimal places.`}
  code={`# Task: Exercise 2 – Float Operations
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use float variables and print results. Try round() to control decimal places.
# Step: Assign the correct value (a number) to 'radius'.
radius = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Assign the correct value to 'area'.
area = ___  # replace ___ with the correct value
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print("Area:", round(area, 2))
print(___)  # replace ___ with the correct expression
...
print("Area:", round(area, 2))`}
  sct={`test_output_contains("78.54")
success_msg("Float arithmetic and rounding works!")`}
  height={150}
/>

### Exercise 3 – Number Type Conversion

<DataCampExercise
  lang="python"
  hint={`Use int(), float(), and complex() to convert between number types.`}
  code={`# Task: Exercise 3 – Number Type Conversion
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Assign the correct value (a number) to 'y'.
y = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(int(y))        # float to int (truncates)
print(___)  # replace ___ with the correct expression
...
y = 3.9
print(int(y))`}
  sct={`test_output_contains("7.0")
test_output_contains("(7+0j)")
test_output_contains("3")
success_msg("Type conversion between numbers works!")`}
  height={180}
/>