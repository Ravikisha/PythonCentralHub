...
## Try it: Tuple Methods Exercises

### Exercise 1 – count()

<DataCampExercise
  lang="python"
  hint={`Use .count() to count how many times 2 appears in the tuple.`}
  code={`# Task: Exercise 1 – count()
...
# Example structure: print("2 appears:", t.count(2))
...
print("2 appears:", t.count(2))`}
  sct={`test_output_contains("2 appears: 3")
success_msg("count() works on tuples!")`}
  height={120}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use .index() to find the position of "cherry".`}
  code={`# Task: Exercise 2 – index()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use .index() to find the position of "cherry".
# Step: Call print() with the right argument(s).
# Example structure: print("cherry at index:", fruits.index("cherry"))
print(___)  # replace ___ with the correct expression
...
print("cherry at index:", fruits.index("cherry"))`}
  sct={`test_output_contains("cherry at index: 2")
success_msg("index() works on tuples!")`}
  height={120}
/>

### Exercise 3 – Convert to List and Back

<DataCampExercise
  lang="python"
  hint={`Convert tuple to list, modify, convert back to tuple.`}
  code={`# Task: Exercise 3 – Convert to List and Back
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
t = tuple(lst)
print(t)`}
  sct={`test_output_contains("1, 2, 3, 4")
success_msg("Tuple conversion works!")`}
  height={150}
/>
