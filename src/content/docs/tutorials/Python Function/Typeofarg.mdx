...
:::note
**You can pass the keyword arguments in any order.** <br></br> 
...
:::note
You can call a function with positional arguments and keyword arguments. <br></br>
...
:::danger
**You cannot pass the positional arguments after the keyword arguments.** <br> </br>
...
## Try it: Function Arguments Exercises

### Exercise 1 – Positional Arguments

<DataCampExercise
  lang="python"
  hint={`Pass arguments in the same order as the function parameters.`}
  code={`# Task: Exercise 1 – Positional Arguments
...
def describe(name, age):
    ...
    # Example structure: print(name, "is", age, "years old")
...
describe("Alice", 30)`}
  sct={`test_output_contains("Alice is 30 years old")
success_msg("Positional arguments work!")`}
  height={140}
/>
...
def total(*nums):
    ...
    # return ___  (should be something like: sum(nums))

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print(total(1, 2, 3, 4, 5))
print(___)  # replace ___ with the correct expression
...
<DataCampExercise
  lang="python"
  hint={`Use **kwargs to accept any number of keyword arguments.`}
  code={`# Task: Exercise 3 – **kwargs
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
def info(**kwargs):
    ...
    for key, val in kwargs.items():
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Call print() with the right argument(s).
        # Example structure: print(key, ":", val)
        print(___)  # replace ___ with the correct expression
...
# ──────────────────────────────────────────────────────────────`}
  solution={`def info(**kwargs):
    for key, val in kwargs.items():
        print(key, ":", val)
info(name="Bob", age=25)`}
  sct={`test_output_contains("name : Bob")
success_msg("**kwargs works!")`}
  height={160}
/>
