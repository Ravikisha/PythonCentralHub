...
<DataCampExercise
  lang="python"
  hint={`Use def to define a function, then call it by name.`}
  code={`# Task: Exercise 1 – Define and Call a Function
...
success_msg("Function definition and call works!")`}
  height={140}
/>

### Exercise 2 – Return a Value

<DataCampExercise
  lang="python"
  hint={`Use return to send a value back from the function.`}
  code={`# Task: Exercise 2 – Return a Value
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use return to send a value back from the function.
# Step: Call print() with the right argument(s).
# Example structure: print("Sum:", result)
print(___)  # replace ___ with the correct expression
...
result = add(3, 5)
print("Sum:", result)`}
  sct={`test_output_contains("Sum: 8")
success_msg("Return value works!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Set a default value in the function signature.`}
  code={`# Task: Exercise 3 – Default Parameter
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
def power(base, exp=2):
    ...
    # Hint: The return statement sends a value back -- place it at the end of the function.
    # Step: Return the computed result.
    # return ___  (should be something like: base ** exp)

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print(power(3))
print(___)  # replace ___ with the correct expression
# Hint: Set a default value in the function signature.
# Step: Call print() with the right argument(s).
# Example structure: print(power(2, 10))
print(___)  # replace ___ with the correct expression
...
print(power(3))
print(power(2, 10))`}
  sct={`test_output_contains("9")
test_output_contains("1024")
success_msg("Default parameter works!")`}
  height={150}
/>
