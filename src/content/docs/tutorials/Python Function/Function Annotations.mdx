...
## Try it: Function Annotations Exercises

### Exercise 1 – Type Hints

<DataCampExercise
  lang="python"
  hint={`Use : for parameter types and -> for return type.`}
  code={`# Task: Exercise 1 – Type Hints
...
success_msg("Type hints work!")`}
  height={130}
/>

### Exercise 2 – Annotations with Default

<DataCampExercise
  lang="python"
  hint={`Combine type hints with default parameter values.`}
  code={`# Task: Exercise 2 – Annotations with Default
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`def greet(name: str, times: int = 1) -> None:
    for _ in range(times):
        print("Hello,", name)
greet("Alice", 2)`}
  sct={`test_output_contains("Hello, Alice")
success_msg("Annotations with default value work!")`}
  height={160}
/>

### Exercise 3 – View Annotations

<DataCampExercise
  lang="python"
  hint={`Use __annotations__ to see the type hints of a function.`}
  code={`# Task: Exercise 3 – View Annotations
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
def multiply(x: float, y: float) -> float:
    ...
    # Hint: The return statement sends a value back -- place it at the end of the function.
    # Step: Return the computed result.
    # return ___  (should be something like: x * y)

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print(multiply.__annotations__)
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`def multiply(x: float, y: float) -> float:
    return x * y
print(multiply.__annotations__)`}
  sct={`test_output_contains("float")
success_msg("__annotations__ works!")`}
  height={140}
/>
