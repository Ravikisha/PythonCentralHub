...
## Try it: Python Module Exercises

### Exercise 1 – Import a Module

<DataCampExercise
  lang="python"
  hint={`Use import to bring in a module and access its functions.`}
  code={`# Task: Exercise 1 – Import a Module
...
# Example structure: print(math.sqrt(25))
print(___)  # replace ___ with the correct expression
# Hint: Use import to bring in a module and access its functions.
# Step: Call print() with the right argument(s).
# Example structure: print(math.pi)
print(___)  # replace ___ with the correct expression
...
print(math.sqrt(25))
print(math.pi)`}
  sct={`test_output_contains("5.0")
success_msg("Module import works!")`}
  height={130}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use from math import to import specific functions directly.`}
  code={`# Task: Exercise 2 – from … import
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print(floor(4.7))
print(___)  # replace ___ with the correct expression
# Hint: Use from math import to import specific functions directly.
# Step: Call print() with the right argument(s).
# Example structure: print(ceil(4.2))
print(___)  # replace ___ with the correct expression
...
<DataCampExercise
  lang="python"
  hint={`Use import ... as to create an alias.`}
  code={`# Task: Exercise 3 – import with alias
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Above import is provided -- understand what it brings in.
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value to 'val'.
val = ___  # replace ___ with the correct value
# Hint: Use import ... as to create an alias.
# Step: Call print() with the right argument(s).
# Example structure: print("Random number generated:", type(val).__name__)
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`import random as r
val = r.randint(1, 100)
print("Random number generated:", type(val).__name__)`}
  sct={`test_output_contains("int")
success_msg("import alias works!")`}
  height={140}
/>
