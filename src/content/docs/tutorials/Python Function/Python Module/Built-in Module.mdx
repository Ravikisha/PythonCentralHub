...
## Try it: Built-in Module Exercises

### Exercise 1 – os Module

<DataCampExercise
  lang="python"
  hint={`Use os.getcwd() to get the current working directory.`}
  code={`# Task: Exercise 1 – os Module
...
# Example structure: print("Type:", type(cwd).__name__)
...
# ──────────────────────────────────────────────────────────────`}
  solution={`import os
cwd = os.getcwd()
print("Type:", type(cwd).__name__)`}
  sct={`test_output_contains("str")
success_msg("os module works!")`}
  height={130}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use datetime.datetime.now() to get the current date and time.`}
  code={`# Task: Exercise 2 – datetime Module
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Above import is provided -- understand what it brings in.
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value to 'now'.
now = ___  # replace ___ with the correct value
# Hint: Use datetime.datetime.now() to get the current date and time.
# Step: Call print() with the right argument(s).
# Example structure: print("Year:", now.year)
print(___)  # replace ___ with the correct expression
...
now = datetime.now()
print("Year:", now.year)`}
  sct={`test_output_contains("Year:")
success_msg("datetime module works!")`}
  height={130}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use random.choice() to pick a random element from a list.`}
  code={`# Task: Exercise 3 – random Module
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Above import is provided -- understand what it brings in.
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a list) to 'options'.
options = ___  # replace ___ with the correct value
# Hint: Use random.choice() to pick a random element from a list.
# Step: Assign the correct value to 'choice'.
choice = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Chosen:", choice in options)
print(___)  # replace ___ with the correct expression
...
print("Chosen:", choice in options)`}
  sct={`test_output_contains("True")
success_msg("random module works!")`}
  height={150}
/>
