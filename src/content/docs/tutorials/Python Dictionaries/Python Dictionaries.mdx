...
<DataCampExercise
  lang="python"
  hint={`Create a dict with keys name and age, then print each value.`}
  code={`# Task: Exercise 1 – Create and Access
...
# Example structure: print(person["name"])
...
success_msg("Dictionary access works!")`}
  height={150}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use .items() to loop over key-value pairs.`}
  code={`# Task: Exercise 2 – Iterate over Items
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: 'for item in iterable:' iterates over each element in sequence.
# Step: Assign the correct value (a dict or set) to 'scores'.
scores = ___  # replace ___ with the correct value
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Write a for loop -- 'for <variable> in <iterable>:'
for name, score in scores.items():
    # Hint: Use .items() to loop over key-value pairs.
    # Step: Call print() with the right argument(s).
    # Example structure: print(name, ":", score)
    print(___)  # replace ___ with the correct expression
...
for name, score in scores.items():
    print(name, ":", score)`}
  sct={`test_output_contains("Alice : 95")
success_msg("Dictionary iteration works!")`}
  height={160}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use len() and .keys() on the dictionary.`}
  code={`# Task: Exercise 3 – Dictionary Length and Keys
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a dict or set) to 'info'.
info = ___  # replace ___ with the correct value
# Hint: Use len() and .keys() on the dictionary.
# Step: Call print() with the right argument(s).
# Example structure: print("Length:", len(info))
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`info = {"brand": "Toyota", "model": "Corolla", "year": 2022}
print("Length:", len(info))`}
  sct={`test_output_contains("Length: 3")
success_msg("Dictionary keys and length work!")`}
  height={130}
/>
