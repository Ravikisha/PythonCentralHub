...
### Exercise 1 – Access Nested Value

<DataCampExercise
  lang="python"
  hint={`Chain bracket notation to access nested values.`}
  code={`# Task: Exercise 1 – Access Nested Value
...
# Step: Assign the correct value (a dict or set) to 'students'.
students = ___  # replace ___ with the correct value
    # Hint: Chain bracket notation to access nested values.
...
# Example structure: print(students["Alice"]["grade"])
...
success_msg("Nested dictionary access works!")`}
  height={170}
/>

### Exercise 2 – Update Nested Value

<DataCampExercise
  lang="python"
  hint={`Access the nested key and assign a new value.`}
  code={`# Task: Exercise 2 – Update Nested Value
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a dict or set) to 'data'.
data = ___  # replace ___ with the correct value
# Hint: Access the nested key and assign a new value.
# Step: Assign the correct value (a number) to 'data["user"]["score"]'.
data["user"]["score"] = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(data["user"]["score"])
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`data = {"user": {"name": "Alice", "score": 80}}
data["user"]["score"] = 95
print(data["user"]["score"])`}
  sct={`test_output_contains("95")
success_msg("Nested update works!")`}
  height={140}
/>

### Exercise 3 – Loop Through Nested Dict

<DataCampExercise
  lang="python"
  hint={`Use .items() on outer dict and access inner keys.`}
  code={`# Task: Exercise 3 – Loop Through Nested Dict
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: 'for item in iterable:' iterates over each element in sequence.
# Step: Assign the correct value (a dict or set) to 'catalog'.
catalog = ___  # replace ___ with the correct value
    # Hint: print(value) displays output; print(a, b) prints multiple values.
    # Step: Write the required code here.
    # "book": {"price": 12},
    # replace the comment above with working code
...
for item, info in catalog.items():
    # Step: Call print() with the right argument(s).
    # Example structure: print(item, "costs", info["price"])
    print(___)  # replace ___ with the correct expression
...
for item, info in catalog.items():
    print(item, "costs", info["price"])`}
  sct={`test_output_contains("book costs 12")
success_msg("Nested dict iteration works!")`}
  height={180}
/>
