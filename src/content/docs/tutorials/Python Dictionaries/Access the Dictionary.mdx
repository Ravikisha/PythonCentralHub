...
## Try it: Access Dictionary Exercises

### Exercise 1 – get() Method

<DataCampExercise
  lang="python"
  hint={`Use .get() to safely access a key without KeyError.`}
  code={`# Task: Exercise 1 – get() Method
...
# Step: Assign the correct value (a dict or set) to 'car'.
car = ___  # replace ___ with the correct value
# Hint: Use .get() to safely access a key without KeyError.
# Step: Call print() with the right argument(s).
# Example structure: print(car.get("brand"))
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(car.get("year", "Not available"))
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`car = {"brand": "Honda", "model": "Civic"}
print(car.get("brand"))
print(car.get("year", "Not available"))`}
  sct={`test_output_contains("Honda")
test_output_contains("Not available")
success_msg("get() method works!")`}
  height={150}
/>

### Exercise 2 – Key Existence Check

<DataCampExercise
  lang="python"
  hint={`Use the in operator to check key membership.`}
  code={`# Task: Exercise 2 – Key Existence Check
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a dict or set) to 'd'.
d = ___  # replace ___ with the correct value
# Hint: Use the in operator to check key membership.
# Step: Call print() with the right argument(s).
# Example structure: print("x" in d)
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("w" in d)
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`d = {"x": 1, "y": 2, "z": 3}
print("x" in d)
print("w" in d)`}
  sct={`test_output_contains("True")
test_output_contains("False")
success_msg("Key existence check works!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Access nested data with chained square bracket notation.`}
  code={`# Task: Exercise 3 – Nested Dictionary
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a dict or set) to 'student'.
student = ___  # replace ___ with the correct value
# Hint: Access nested data with chained square bracket notation.
# Step: Call print() with the right argument(s).
# Example structure: print(student["grades"]["math"])
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`student = {"name": "Bob", "grades": {"math": 90, "science": 85}}
print(student["grades"]["math"])`}
  sct={`test_output_contains("90")
