...
<DataCampExercise
  lang="python"
  hint={`Try comparison operators: ==, !=, >, <, >=, <=. They all return True or False.`}
  code={`# Task: Exercise 1 – Boolean Values and Comparisons
...
success_msg("Boolean comparisons work!")`}
  height={170}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use and, or, not. Remember: True and False = False, True or False = True.`}
  code={`# Task: Exercise 2 – Logical Operators
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
success_msg("Logical operators mastered!")`}
  height={180}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use an if statement with a boolean condition.`}
  code={`# Task: Exercise 3 – Boolean in Conditions
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: Structure: if condition: / elif condition: / else:
# Step: Assign the correct value (True or False) to 'is_raining'.
is_raining = ___  # replace ___ with the correct value
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (True or False) to 'is_cold'.
is_cold = ___  # replace ___ with the correct value

# Hint: Use an if statement with a boolean condition.
if is_raining and not is_cold:
    # Hint: Run after every change -- small steps are easier to debug!
    # Step: Call print() with the right argument(s).
    # Example structure: print("Take an umbrella!")
    print(___)  # replace ___ with the correct expression
# Hint: Read error messages carefully -- they point to the exact line.
elif is_raining and is_cold:
    # Step: Call print() with the right argument(s).
    # Example structure: print("Take an umbrella and a coat!")
    print(___)  # replace ___ with the correct expression
else:
    # Step: Call print() with the right argument(s).
    # Example structure: print("Nice weather today!")
    print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# Take an umbrella!
# Take an umbrella and a coat!
# Nice weather today!
# ──────────────────────────────────────────────────────────────`}
...
if is_raining and not is_cold:
  ...
  sct={`test_output_contains("Take an umbrella!")
success_msg("Boolean conditions in if statements work!")`}
  height={230}
/>
