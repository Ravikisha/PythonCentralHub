...
## Try it: Interactive Python (DataCamp Light)

Below is a small interactive editor powered by DataCamp Light.

<DataCampExercise
  lang="python"
  hint={`Try changing the text inside print(...), then run it again.`}
  preExerciseCode={`# This code runs before the exercise.
# You can use it to predefine variables or helper functions.`}
...
success_msg("Nice! You ran Python code in the browser.")`}
height={100}
/>
