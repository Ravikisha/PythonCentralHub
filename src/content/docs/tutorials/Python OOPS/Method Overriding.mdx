...
## Try it: Method Overriding Exercises

### Exercise 1 – Override Parent Method

<DataCampExercise
  lang="python"
  hint={`Define the same method name in the child class to override it.`}
  code={`# Task: Exercise 1 – Override Parent Method
...
class Animal:
    ...
    def sound(self):
        ...
        # return ___  (should be something like: "Some generic sound")
...
class Dog(Animal):
    ...
    def sound(self):
        ...
        # Step: Return the computed result.
        # return ___  (should be something like: "Bark!")

# Step: Assign the correct value to 'd'.
d = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(d.sound())
...
d = Dog()
print(d.sound())`}
  sct={`test_output_contains("Bark!")
success_msg("Method overriding works!")`}
  height={190}
/>

### Exercise 2 – Call super() in Override

<DataCampExercise
  lang="python"
  hint={`Use super() to call the parent's version of the method.`}
  code={`# Task: Exercise 2 – Call super() in Override
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Base:
    ...
    def greet(self):
        # Step: Write the function body here.
        pass  # remove 'pass' and add your code
        # Hint: Call the parent constructor with super().__init__(arg1, arg2, ...).
        # Step: Return the computed result.
        # return ___  (should be something like: "Hello from Base")
...
class Child(Base):
    ...
    def greet(self):
        ...
        pass  # remove 'pass' and add your code
        # Hint: Use super() to call the parent's version of the method.
        # Step: Assign the correct value to 'parent_msg'.
        parent_msg = ___  # replace ___ with the correct value
        # Step: Return the computed result.
        # return ___  (should be something like: parent_msg + " and Child")

# Step: Assign the correct value to 'c'.
c = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(c.greet())
print(___)  # replace ___ with the correct expression
...
c = Child()
print(c.greet())`}
  sct={`test_output_contains("Hello from Base and Child")
success_msg("super() in override works!")`}
  height={210}
/>

### Exercise 3 – Polymorphic Override

<DataCampExercise
  lang="python"
  hint={`Call the same method name on different objects to see different results.`}
  code={`# Task: Exercise 3 – Polymorphic Override
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Shape:
    ...
    def describe(self):
        ...
        # Step: Return the computed result.
        # return ___  (should be something like: "I am a shape")
...
class Triangle(Shape):
    ...
    def describe(self):
        ...
        # Hint: Call the same method name on different objects to see different results.
        # Step: Return the computed result.
        # return ___  (should be something like: "I am a triangle")
...
class Hexagon(Shape):
    ...
    def describe(self):
        ...
        pass  # remove 'pass' and add your code
        # Step: Return the computed result.
        # return ___  (should be something like: "I am a hexagon")

# Step: Write a for loop -- 'for <variable> in <iterable>:'
for s in [Shape(), Triangle(), Hexagon()]:
    # Step: Call print() with the right argument(s).
    # Example structure: print(s.describe())
    print(___)  # replace ___ with the correct expression
...
for s in [Shape(), Triangle(), Hexagon()]:
    print(s.describe())`}
  sct={`test_output_contains("I am a shape")
test_output_contains("I am a triangle")
test_output_contains("I am a hexagon")
success_msg("Polymorphic overriding works!")`}
  height={260}
/>
