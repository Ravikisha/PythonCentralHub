...
<DataCampExercise
  lang="python"
  hint={`Use ABC and @abstractmethod to define abstract methods.`}
  code={`# Task: Exercise 1 – Abstract Class
...
c = Circle(5)
print(f"{c.area():.2f}")`}
  sct={`test_output_contains("78.50")
success_msg("Abstract class works!")`}
  height={250}
/>
...
<DataCampExercise
  lang="python"
  hint={`A concrete class must implement ALL abstract methods.`}
...
class Car(Vehicle):
    ...
    def start(self):
        ...
        # Step: Call print() with the right argument(s).
        # Example structure: print("Car started")
        print(___)  # replace ___ with the correct expression
    def stop(self):
        # Step: Write the function body here.
        pass  # remove 'pass' and add your code
        # Step: Call print() with the right argument(s).
        # Example structure: print("Car stopped")
        print(___)  # replace ___ with the correct expression
...
c.start()
c.stop()`}
  sct={`test_output_contains("Car started")
test_output_contains("Car stopped")
success_msg("Multiple abstract methods work!")`}
  height={280}
/>

### Exercise 3 – Abstraction with Property

<DataCampExercise
  lang="python"
  hint={`You can also make abstract properties.`}
  code={`# Task: Exercise 3 – Abstraction with Property
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
d = Dog()
print(d.name)`}
  sct={`test_output_contains("Dog")
success_msg("Abstract property works!")`}
  height={240}
/>
