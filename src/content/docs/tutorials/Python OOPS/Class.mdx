...
## Try it: Python Class Exercises

### Exercise 1 – Class with Attributes

<DataCampExercise
  lang="python"
  hint={`Define a class with instance attributes set in __init__.`}
  code={`# Task: Exercise 1 – Class with Attributes
...
class Person:
    ...
    def __init__(self, name, age):
        ...
        # Hint: Define a class with instance attributes set in __init__.
        # Step: Assign the correct value to 'self.age'.
        self.age = ___  # replace ___ with the correct value
...
# Example structure: print(p.name, p.age)
...
p = Person("Alice", 30)
print(p.name, p.age)`}
  sct={`test_output_contains("Alice 30")
success_msg("Class attributes work!")`}
  height={170}
/>
...
<DataCampExercise
  lang="python"
  hint={`Add a method that prints a formatted string using self attributes.`}
  code={`# Task: Exercise 2 – Class Method
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Rectangle:
    ...
    def __init__(self, w, h):
        ...
        # Step: Assign the correct value to 'self.w'.
        self.w = ___  # replace ___ with the correct value
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Assign the correct value to 'self.h'.
        self.h = ___  # replace ___ with the correct value
    # Hint: Add a method that prints a formatted string using self attributes.
    def area(self):
        # Step: Write the function body here.
        pass  # remove 'pass' and add your code
        ...
        # return ___  (should be something like: self.w * self.h)

# Step: Assign the correct value to 'r'.
r = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print("Area:", r.area())
print(___)  # replace ___ with the correct expression
...
r = Rectangle(5, 3)
print("Area:", r.area())`}
  sct={`test_output_contains("Area: 15")
success_msg("Class method works!")`}
  height={190}
/>
...
<DataCampExercise
  lang="python"
  hint={`Define __str__ to control how the object prints.`}
  code={`# Task: Exercise 3 – __str__ Method
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Point:
    ...
    def __init__(self, x, y):
        ...
        pass  # remove 'pass' and add your code
        # Hint: The return statement sends a value back -- place it at the end of the function.
        # Step: Assign the correct value to 'self.x'.
        self.x = ___  # replace ___ with the correct value
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Assign the correct value to 'self.y'.
        self.y = ___  # replace ___ with the correct value
    # Hint: Define __str__ to control how the object prints.
    def __str__(self):
        # Step: Write the function body here.
        pass  # remove 'pass' and add your code
        # Hint: Run after every change -- small steps are easier to debug!
        # Step: Return the computed result.
        # return ___  (should be something like: f"({self.x}, {self.y})")

# Step: Assign the correct value to 'p'.
p = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(p)
print(___)  # replace ___ with the correct expression
...
p = Point(3, 4)
print(p)`}
  sct={`test_output_contains("(3, 4)")
success_msg("__str__ method works!")`}
  height={200}
/>
