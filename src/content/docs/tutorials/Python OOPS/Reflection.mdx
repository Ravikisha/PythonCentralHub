...
## Try it: Reflection Exercises

### Exercise 1 – getattr()

<DataCampExercise
  lang="python"
  hint={`getattr(obj, "name") returns the attribute named "name" from obj.`}
  code={`# Task: Exercise 1 – getattr()
...
# Example structure: print(getattr(p, "name"))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(getattr(p, "age"))
print(___)  # replace ___ with the correct expression
...
test_output_contains("30")
success_msg("getattr() works!")`}
  height={190}
/>

### Exercise 2 – hasattr() and setattr()

<DataCampExercise
  lang="python"
  hint={`hasattr checks if an attribute exists; setattr sets it.`}
  code={`# Task: Exercise 2 – hasattr() and setattr()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(hasattr(c, "debug"))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(c.debug)
print(___)  # replace ___ with the correct expression
...
c = Config()
setattr(c, "debug", True)
print(hasattr(c, "debug"))
print(c.debug)`}
  sct={`test_output_contains("True")
success_msg("hasattr() and setattr() work!")`}
  height={170}
/>

### Exercise 3 – dir() and vars()

<DataCampExercise
  lang="python"
  hint={`vars(obj) returns the __dict__ of the object. dir() lists all attributes.`}
  code={`# Task: Exercise 3 – dir() and vars()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(vars(p))
print(___)  # replace ___ with the correct expression
...
p = Point(1, 2)
print(vars(p))`}
  sct={`test_output_contains("'x': 1")
test_output_contains("'y': 2")
success_msg("vars() reflection works!")`}
  height={180}
/>
