...
### Exercise 1 – Instance Method

<DataCampExercise
  lang="python"
  hint={`Instance methods take self as the first parameter.`}
  code={`# Task: Exercise 1 – Instance Method
...
class BankAccount:
    ...
    def __init__(self, balance=0):
        ...
        # Step: Assign the correct value to 'self.balance'.
        self.balance = ___  # replace ___ with the correct value
    # Hint: Instance methods take self as the first parameter.
    def deposit(self, amount):
        ...
        # Example structure: print("Balance:", self.balance)
...
acc = BankAccount(100)
acc.deposit(50)`}
  sct={`test_output_contains("Balance: 150")
success_msg("Instance method works!")`}
  height={200}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use @classmethod and cls to access class-level state.`}
...
class Dog:
    ...
    def get_count(cls):
        ...
        # return ___  (should be something like: cls.count)
...
# replace the comment above with working code
# Step: Call print() with the right argument(s).
# Example structure: print("Dogs:", Dog.get_count())
print(___)  # replace ___ with the correct expression
...
Dog("Rex")
Dog("Buddy")
print("Dogs:", Dog.get_count())`}
  sct={`test_output_contains("Dogs: 2")
...
<DataCampExercise
  lang="python"
  hint={`@staticmethod doesn't take self or cls.`}
  code={`# Task: Exercise 3 – Static Method
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Math:
    ...
    def square(n):
        ...
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Return the computed result.
        # return ___  (should be something like: n ** 2)

# Hint: @staticmethod doesn't take self or cls.
# Step: Call print() with the right argument(s).
# Example structure: print(Math.square(7))
print(___)  # replace ___ with the correct expression
...
# ──────────────────────────────────────────────────────────────`}
  solution={`class Math:
    ...
    def square(n):
        return n ** 2
print(Math.square(7))`}
  sct={`test_output_contains("49")
success_msg("Static method works!")`}
  height={150}
/>
