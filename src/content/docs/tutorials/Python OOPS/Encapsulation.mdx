...
## Try it: Encapsulation Exercises

### Exercise 1 – Private Attribute

<DataCampExercise
  lang="python"
  hint={`Prefix with __ to make an attribute private. Access via a method.`}
  code={`# Task: Exercise 1 – Private Attribute
...
class BankAccount:
    ...
    def __init__(self, balance):
        ...
        # Step: Assign the correct value to 'self.__balance'.
        self.__balance = ___  # replace ___ with the correct value
    ...
    def get_balance(self):
        ...
        # return ___  (should be something like: self.__balance)

# Hint: Run after every change -- small steps are easier to debug!
# Step: Assign the correct value to 'acc'.
acc = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(acc.get_balance())
...
print(acc.get_balance())`}
  sct={`test_output_contains("500")
success_msg("Private attribute with getter works!")`}
  height={190}
/>

### Exercise 2 – Setter Method

<DataCampExercise
  lang="python"
  hint={`Add a setter method to validate before updating the private attribute.`}
  code={`# Task: Exercise 2 – Setter Method
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Person:
    ...
    def __init__(self, age):
        ...
        # Step: Assign the correct value to 'self.__age'.
        self.__age = ___  # replace ___ with the correct value
    # Hint: The return statement sends a value back -- place it at the end of the function.
    ...
    def get_age(self):
        ...
        pass  # remove 'pass' and add your code
        # Step: Return the computed result.
        # return ___  (should be something like: self.__age)
...
# Step: Call print() with the right argument(s).
# Example structure: print(p.get_age())
print(___)  # replace ___ with the correct expression
...
p.set_age(30)
print(p.get_age())`}
  sct={`test_output_contains("30")
success_msg("Setter with validation works!")`}
  height={230}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use @property for getter and @name.setter for setter.`}
  code={`# Task: Exercise 3 – @property Decorator
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Temperature:
    ...
    def __init__(self, celsius):
        ...
        pass  # remove 'pass' and add your code
        # Hint: The return statement sends a value back -- place it at the end of the function.
        # Step: Assign the correct value to 'self._celsius'.
        self._celsius = ___  # replace ___ with the correct value
    # Hint: print(value) displays output; print(a, b) prints multiple values.
    # Step: Write the required code here.
    # @property
    # replace the comment above with working code
    ...
    def fahrenheit(self):
        ...
        # Hint: Run after every change -- small steps are easier to debug!
        # Step: Return the computed result.
        # return ___  (should be something like: self._celsius * 9/5 + 32)

# Step: Assign the correct value to 't'.
t = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(t.fahrenheit)
print(___)  # replace ___ with the correct expression
...
t = Temperature(100)
print(t.fahrenheit)`}
  sct={`test_output_contains("212.0")
success_msg("@property decorator works!")`}
  height={200}
/>
