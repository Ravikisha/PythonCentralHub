...
## Try it: Decorator Exercises

### Exercise 1 – Simple Decorator

<DataCampExercise
  lang="python"
  hint={`A decorator is a function that wraps another function.`}
  code={`# Task: Exercise 1 – Simple Decorator
...
def greet():
    ...
    pass  # remove 'pass' and add your code
    # Step: Return the computed result.
    # return ___  (should be something like: "hello")

# Step: Call print() with the right argument(s).
# Example structure: print(greet())
...
success_msg("Simple decorator works!")`}
  height={210}
/>

### Exercise 2 – @property Decorator

<DataCampExercise
  lang="python"
  hint={`@property allows you to access a method like an attribute.`}
  code={`# Task: Exercise 2 – @property Decorator
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Circle:
    ...
    def __init__(self, radius):
        ...
        pass  # remove 'pass' and add your code
        # Hint: The return statement sends a value back -- place it at the end of the function.
        # Step: Assign the correct value to 'self.radius'.
        self.radius = ___  # replace ___ with the correct value
    # Hint: print(value) displays output; print(a, b) prints multiple values.
    # Step: Write the required code here.
    # @property
    # replace the comment above with working code
    ...
    def diameter(self):
        ...
        # Hint: Run after every change -- small steps are easier to debug!
        # Step: Return the computed result.
        # return ___  (should be something like: self.radius * 2)

# Step: Assign the correct value to 'c'.
c = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print("Diameter:", c.diameter)
print(___)  # replace ___ with the correct expression
...
print("Diameter:", c.diameter)`}
  sct={`test_output_contains("Diameter: 10")
success_msg("@property decorator works!")`}
  height={190}
/>

### Exercise 3 – @staticmethod

<DataCampExercise
  lang="python"
  hint={`@staticmethod is a decorator that defines a method with no self or cls.`}
  code={`# Task: Exercise 3 – @staticmethod
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Converter:
    ...
    def c_to_f(celsius):
        ...
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Return the computed result.
        # return ___  (should be something like: celsius * 9/5 + 32)

# Hint: @staticmethod is a decorator that defines a method with no self or cls.
# Step: Call print() with the right argument(s).
# Example structure: print(Converter.c_to_f(100))
print(___)  # replace ___ with the correct expression
...
print(Converter.c_to_f(100))`}
  sct={`test_output_contains("212.0")
success_msg("@staticmethod decorator works!")`}
  height={150}
/>
