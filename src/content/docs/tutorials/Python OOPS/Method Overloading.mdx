...
## Try it: Method Overloading Exercises

### Exercise 1 – Default Arguments as Overloading

<DataCampExercise
  lang="python"
  hint={`Python doesn't support true overloading, but default args achieve similar behavior.`}
  code={`# Task: Exercise 1 – Default Arguments as Overloading
...
class Math:
    ...
    def add(self, a, b=0, c=0):
        ...
        # return ___  (should be something like: a + b + c)

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value to 'm'.
m = ___  # replace ___ with the correct value
# Hint: Python doesn't support true overloading, but default args achieve similar behavior.
# Step: Call print() with the right argument(s).
# Example structure: print(m.add(1))
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(m.add(1, 2))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(m.add(1, 2, 3))
print(___)  # replace ___ with the correct expression
...
success_msg("Default arg overloading works!")`}
  height={200}
/>

### Exercise 2 – *args Approach

<DataCampExercise
  lang="python"
  hint={`Use *args to accept a variable number of arguments.`}
  code={`# Task: Exercise 2 – *args Approach
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Calculator:
    ...
    def multiply(self, *args):
        ...
        # Step: Assign the correct value (a number) to 'result'.
        result = ___  # replace ___ with the correct value
        # Hint: The return statement sends a value back -- place it at the end of the function.
        ...
        # Hint: Use *args to accept a variable number of arguments.
        # Step: Return the computed result.
        # return ___  (should be something like: result)

# Step: Assign the correct value to 'c'.
c = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(c.multiply(2, 3))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(c.multiply(2, 3, 4))
print(___)  # replace ___ with the correct expression
...
success_msg("*args overloading works!")`}
  height={210}
/>

### Exercise 3 – multipledispatch (Simulated)

<DataCampExercise
  lang="python"
  hint={`Check argument types to simulate true overloading.`}
  code={`# Task: Exercise 3 – multipledispatch (Simulated)
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Formatter:
    ...
    def format(self, value):
        ...
        if isinstance(value, int):
            # Hint: The return statement sends a value back -- place it at the end of the function.
            # Step: Return the computed result.
            # return ___  (should be something like: f"Integer: {value}")
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        elif isinstance(value, str):
            # Hint: Check argument types to simulate true overloading.
            # Step: Return the computed result.
            # return ___  (should be something like: f"String: {value}")
        # Step: Return the computed result.
        # return ___  (should be something like: str(value))

# Step: Assign the correct value to 'f'.
f = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(f.format(42))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(f.format("hello"))
print(___)  # replace ___ with the correct expression
...
print(f.format("hello"))`}
  sct={`test_output_contains("Integer: 42")
test_output_contains("String: hello")
success_msg("Type-based overloading works!")`}
  height={240}
/>
