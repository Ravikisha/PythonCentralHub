...
## Try it: Constructor Exercises

### Exercise 1 – Default Constructor

<DataCampExercise
  lang="python"
  hint={`__init__ is the constructor that runs when an object is created.`}
  code={`# Task: Exercise 1 – Default Constructor
...
class Greeter:
    ...
    def __init__(self):
        ...
        # Example structure: print("Object created!")
        print(___)  # replace ___ with the correct expression

# Hint: __init__ is the constructor that runs when an object is created.
# Step: Assign the correct value to 'g'.
g = ___  # replace ___ with the correct value
...
g = Greeter()`}
  sct={`test_output_contains("Object created!")
success_msg("Default constructor works!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Pass arguments to __init__ to set initial state.`}
  code={`# Task: Exercise 2 – Parameterized Constructor
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Circle:
    ...
    def area(self):
        ...
        # return ___  (should be something like: 3.14 * self.radius ** 2)
...
# Step: Call print() with the right argument(s).
# Example structure: print(f"Area: {c.area():.2f}")
print(___)  # replace ___ with the correct expression
...
print(f"Area: {c.area():.2f}")`}
  sct={`test_output_contains("Area: 78.50")
success_msg("Parameterized constructor works!")`}
  height={190}
/>

### Exercise 3 – Constructor with Default

<DataCampExercise
  lang="python"
  hint={`Use default parameter values in __init__.`}
  code={`# Task: Exercise 3 – Constructor with Default
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Counter:
    ...
    def __init__(self, start=0):
        ...
        pass  # remove 'pass' and add your code
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Assign the correct value to 'self.count'.
        self.count = ___  # replace ___ with the correct value
    # Hint: Use default parameter values in __init__.
    def increment(self):
        # Step: Write the function body here.
        pass  # remove 'pass' and add your code
...
# replace the comment above with working code
# Step: Call print() with the right argument(s).
# Example structure: print(c.count)
print(___)  # replace ___ with the correct expression
...
success_msg("Constructor default works!")`}
  height={200}
/>
