...
## Try it: Access Modifiers Exercises

### Exercise 1 – Public Attribute

<DataCampExercise
  lang="python"
  hint={`Public attributes are accessible from anywhere.`}
  code={`# Task: Exercise 1 – Public Attribute
...
# Example structure: print(s.name)
...
success_msg("Public attribute works!")`}
  height={150}
/>

### Exercise 2 – Protected Attribute

<DataCampExercise
  lang="python"
  hint={`Protected attributes use a single underscore prefix _.`}
  code={`# Task: Exercise 2 – Protected Attribute
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Person:
    ...
    def __init__(self, age):
        ...
        pass  # remove 'pass' and add your code
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Assign the correct value to 'self._age'.
        self._age = ___  # replace ___ with the correct value
    # Hint: Protected attributes use a single underscore prefix _.
    def show(self):
        # Step: Write the function body here.
        pass  # remove 'pass' and add your code
        # Hint: Run after every change -- small steps are easier to debug!
        # Step: Call print() with the right argument(s).
        # Example structure: print("Age:", self._age)
        print(___)  # replace ___ with the correct expression
...
p = Person(25)
p.show()`}
  sct={`test_output_contains("Age: 25")
success_msg("Protected attribute works!")`}
  height={180}
/>
...
<DataCampExercise
  lang="python"
  hint={`Private attributes use __ prefix. Access via _ClassName__attr.`}
  code={`# Task: Exercise 3 – Private Attribute with Name Mangling
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Account:
    ...
    def __init__(self, pin):
        ...
        pass  # remove 'pass' and add your code
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Assign the correct value to 'self.__pin'.
        self.__pin = ___  # replace ___ with the correct value

# Hint: Private attributes use __ prefix. Access via _ClassName__attr.
# Step: Assign the correct value to 'a'.
a = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(a._Account__pin)
print(___)  # replace ___ with the correct expression
...
print(a._Account__pin)`}
  sct={`test_output_contains("1234")
success_msg("Name mangling works!")`}
  height={160}
/>
