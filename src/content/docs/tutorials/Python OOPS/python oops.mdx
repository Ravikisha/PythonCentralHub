...
## Try it: Python OOP Exercises

### Exercise 1 – Create a Class

<DataCampExercise
  lang="python"
  hint={`Define a class with __init__ to set instance attributes.`}
  code={`# Task: Exercise 1 – Create a Class
...
# Hint: Define a class with __init__ to set instance attributes.
# Step: Assign the correct value to 'dog'.
dog = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(dog.name)
...
dog = Dog("Rex")
print(dog.name)`}
  sct={`test_output_contains("Rex")
success_msg("Class creation works!")`}
  height={150}
/>
...
<DataCampExercise
  lang="python"
  hint={`Define a method inside the class that uses self.`}
  code={`# Task: Exercise 2 – Add a Method
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Car:
    ...
    def info(self):
        ...
        # Hint: Run after every change -- small steps are easier to debug!
        # Step: Call print() with the right argument(s).
        # Example structure: print("Brand:", self.brand)
        print(___)  # replace ___ with the correct expression
...
c = Car("Toyota")
c.info()`}
  sct={`test_output_contains("Brand: Toyota")
...
<DataCampExercise
  lang="python"
  hint={`Use class Child(Parent) to inherit from a parent class.`}
  code={`# Task: Exercise 3 – Inheritance
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Animal:
    ...
    def speak(self):
        ...
        # Hint: print(value) displays output; print(a, b) prints multiple values.
        # Step: Call print() with the right argument(s).
        # Example structure: print("Some sound")
        print(___)  # replace ___ with the correct expression
...
c = Cat()
c.speak()`}
  sct={`test_output_contains("Meow")
success_msg("Inheritance and override works!")`}
  height={190}
/>
