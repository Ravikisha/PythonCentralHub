...
## Try it: Inheritance Exercises

### Exercise 1 – Basic Inheritance

<DataCampExercise
  lang="python"
  hint={`A child class inherits attributes and methods from the parent.`}
  code={`# Task: Exercise 1 – Basic Inheritance
...
class Animal:
    ...
    def speak(self):
        ...
        # return ___  (should be something like: "...")
...
# Example structure: print(d.name, d.speak())
...
print(d.name, d.speak())`}
  sct={`test_output_contains("Rex Woof!")
success_msg("Inheritance works!")`}
  height={220}
/>
...
class Vehicle:
    ...
    def __init__(self, brand):
        ...
        # Step: Assign the correct value to 'self.brand'.
        self.brand = ___  # replace ___ with the correct value
...
class Car(Vehicle):
    ...
    def __init__(self, brand, model):
        ...
        pass  # remove 'pass' and add your code
        # Hint: Run after every change -- small steps are easier to debug!
        # Step: Call the parent constructor via super().__init__(...).
        # super().__init__(___)  fill in the parent's required arguments
        # Step: Assign the correct value to 'self.model'.
        self.model = ___  # replace ___ with the correct value

# Step: Assign the correct value to 'c'.
c = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(c.brand, c.model)
print(___)  # replace ___ with the correct expression
...
print(c.brand, c.model)`}
  sct={`test_output_contains("Toyota Corolla")
success_msg("super() works!")`}
  height={230}
/>

### Exercise 3 – isinstance()

<DataCampExercise
  lang="python"
  hint={`Use isinstance() to check if an object belongs to a class.`}
  code={`# Task: Exercise 3 – isinstance()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
c = ___  # replace ___ with the correct value
# Step: Call print() with the right argument(s).
# Example structure: print(isinstance(c, Circle))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(isinstance(c, Shape))
print(___)  # replace ___ with the correct expression
