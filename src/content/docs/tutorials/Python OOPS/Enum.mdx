...
<DataCampExercise
  lang="python"
  hint={`Use the Enum class to define a group of named constants.`}
  code={`# Task: Exercise 1 – Basic Enum
...
class Color(Enum):
    ...
    # Step: Assign the correct value (a number) to 'RED'.
    RED = ___  # replace ___ with the correct value
    # Hint: Use the Enum class to define a group of named constants.
    # Step: Assign the correct value (a number) to 'GREEN'.
    GREEN = ___  # replace ___ with the correct value
    # Hint: Run after every change -- small steps are easier to debug!
    # Step: Assign the correct value (a number) to 'BLUE'.
    BLUE = ___  # replace ___ with the correct value

# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(Color.RED)
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(Color.RED.value)
print(___)  # replace ___ with the correct expression
...
print(Color.RED.value)`}
  sct={`test_output_contains("Color.RED")
test_output_contains("1")
success_msg("Basic Enum works!")`}
  height={200}
/>

### Exercise 2 – Iterating Enum

<DataCampExercise
  lang="python"
  hint={`You can iterate over Enum members with a for loop.`}
  code={`# Task: Exercise 2 – Iterating Enum
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Day(Enum):
    ...
    # Step: Assign the correct value (a number) to 'MON'.
    MON = ___  # replace ___ with the correct value
    # Hint: print(value) displays output; print(a, b) prints multiple values.
    # Step: Assign the correct value (a number) to 'TUE'.
    TUE = ___  # replace ___ with the correct value
    # Hint: You can iterate over Enum members with a for loop.
    # Step: Assign the correct value (a number) to 'WED'.
    WED = ___  # replace ___ with the correct value

# Hint: Run after every change -- small steps are easier to debug!
# Step: Write a for loop -- 'for <variable> in <iterable>:'
for day in Day:
    # Step: Call print() with the right argument(s).
    # Example structure: print(day.name, day.value)
    print(___)  # replace ___ with the correct expression
...
for day in Day:
  ...
  sct={`test_output_contains("MON 1")
test_output_contains("TUE 2")
success_msg("Enum iteration works!")`}
  height={200}
/>

### Exercise 3 – Enum Comparison

<DataCampExercise
  lang="python"
  hint={`Compare Enum members with == or is.`}
  code={`# Task: Exercise 3 – Enum Comparison
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
class Status(Enum):
    # Step: Define the class body (attributes, __init__, methods).
    # Hint: print(value) displays output; print(a, b) prints multiple values.
    # Step: Assign the correct value (a number) to 'ACTIVE'.
    ACTIVE = ___  # replace ___ with the correct value
    # Hint: Compare Enum members with == or is.
    # Step: Assign the correct value (a number) to 'INACTIVE'.
    INACTIVE = ___  # replace ___ with the correct value
...
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(s == Status.ACTIVE)
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(s == Status.INACTIVE)
print(___)  # replace ___ with the correct expression
...
success_msg("Enum comparison works!")`}
  height={200}
/>
