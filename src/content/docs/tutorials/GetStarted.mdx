...
<DataCampExercise
  ...
  code={`# Task: Exercise 2 – Print Your Name
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Create a variable name = "Your Name" and print it.
# Step: Call print() with the right argument(s).
# Example structure: print("My name is", name)
print(___)  # replace ___ with the correct expression
...
<DataCampExercise
  ...
  code={`# Task: Exercise 3 – Run a Simple Script
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Simulate running a small Python script
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print("Starting script...")
print(___)  # replace ___ with the correct expression
# Hint: Combine multiple print statements to simulate a script.
...
# Step: Call print() with the right argument(s).
# Example structure: print("The answer is:", x)
print(___)  # replace ___ with the correct expression
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print("Script complete.")
print(___)  # replace ___ with the correct expression
