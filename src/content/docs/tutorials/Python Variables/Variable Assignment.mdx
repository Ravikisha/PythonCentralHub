...
<DataCampExercise
  ...
  code={`# Task: Exercise 1 – Assign and Print a Variable
...
# Step: Assign the correct value (a number) to 'answer'.
answer = ___  # replace ___ with the correct value
# Hint: Assign the value 42 to a variable called answer and print it.
# Step: Call print() with the right argument(s).
# Example structure: print(answer)
...
<DataCampExercise
  ...
  code={`# Task: Exercise 2 – Reassign a Variable
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
<DataCampExercise
  ...
  code={`# Task: Exercise 3 – Swap Two Variables
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
