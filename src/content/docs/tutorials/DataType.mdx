...
<DataCampExercise
  lang="python"
  hint={`Use type() to check the data type of a variable, e.g. print(type(42))`}
  code={`# Task: Exercise 1 – Identify Data Types
...
print(type(True))
print(type([1, 2, 3]))`}
  sct={`test_output_contains("int")
test_output_contains("float")
test_output_contains("str")
test_output_contains("bool")
test_output_contains("list")
success_msg("You can identify Python data types!")`}
  height={180}
/>
...
<DataCampExercise
  lang="python"
  hint={`Create variables of different types and print them with their types.`}
  code={`# Task: Exercise 2 – Working with Different Types
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Step: Assign the correct value to 'is_student'.
is_student = ___  # replace ___ with the correct value

# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(name, type(name))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(age, type(age))
print(___)  # replace ___ with the correct expression
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(height, type(height))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(is_student, type(is_student))
print(___)  # replace ___ with the correct expression
...
test_output_contains("float")
test_output_contains("bool")
success_msg("Great! You've mastered Python's basic data types.")`}
  height={220}
/>
...
<DataCampExercise
  lang="python"
  hint={`Create a list, tuple, and dictionary and print their types.`}
  code={`# Task: Exercise 3 – Collections
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Create a list, tuple, and dictionary and print their types.
# Step: Assign the correct value (a tuple or function call) to 'my_tuple'.
my_tuple = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Assign the correct value (a dict or set) to 'my_dict'.
my_dict = ___  # replace ___ with the correct value

# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(type(my_list))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(type(my_tuple))
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(type(my_dict))
print(___)  # replace ___ with the correct expression
...
print(type(my_tuple))
print(type(my_dict))`}
  sct={`test_output_contains("list")
test_output_contains("tuple")
test_output_contains("dict")
success_msg("Collections identified correctly!")`}
  height={190}
/>