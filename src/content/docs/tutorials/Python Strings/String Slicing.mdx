...
## Try it: String Slicing Exercises

### Exercise 1 – Basic Slicing

<DataCampExercise
  lang="python"
  hint={`Use [start:end] to extract a substring. Remember: end index is exclusive.`}
  code={`# Task: Exercise 1 – Basic Slicing
...
test_output_contains("Programming")
success_msg("String slicing works!")`}
  height={150}
/>

### Exercise 2 – Slice with Step

<DataCampExercise
  lang="python"
  hint={`Use [::2] to get every second character of the string.`}
  code={`# Task: Exercise 2 – Slice with Step
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use [::2] to get every second character of the string.
# Step: Call print() with the right argument(s).
# Example structure: print(text[::2])
print(___)  # replace ___ with the correct expression
...
print(text[::2])`}
  sct={`test_output_contains("aceg")
success_msg("Step slicing works!")`}
  height={120}
/>
...
<DataCampExercise
  ...
  code={`# Task: Exercise 3 – Reverse a String
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
text = ___  # replace ___ with the correct value
# Hint: Use [::-1] to reverse a string.
# Step: Assign the correct value to 'reversed_text'.
reversed_text = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(reversed_text)
print(___)  # replace ___ with the correct expression
...
print(reversed_text)`}
  sct={`test_output_contains("nohtyP")
success_msg("String reversal with slicing works!")`}
  height={130}
/>
