...
## Try it: String Formatting Exercises

### Exercise 1 – f-string Basics

<DataCampExercise
  lang="python"
  hint={`Use an f-string to embed the name variable directly into the greeting.`}
  code={`# Task: Exercise 1 – f-string Basics
...
# Example structure: print(f"My name is {name} and I am {age} years old.")
...
print(f"My name is {name} and I am {age} years old.")`}
  sct={`test_output_contains("My name is Alice and I am 30 years old.")
success_msg("f-string formatting works!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use .format() with positional placeholders {0} and {1}.`}
  code={`# Task: Exercise 2 – .format() Method
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a string) to 'item'.
item = ___  # replace ___ with the correct value
# Hint: Use .format() with positional placeholders {0} and {1}.
# Step: Assign the correct value (a number) to 'price'.
price = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("The {} costs \${:.2f}".format(item, price))
print(___)  # replace ___ with the correct expression
...
print("The {} costs \${:.2f}".format(item, price))`}
  sct={`test_output_contains("The book costs $12.50")
success_msg(".format() works correctly!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use f-string with :.2f to format a float to 2 decimal places.`}
  code={`# Task: Exercise 3 – Number Formatting
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use f-string with :.2f to format a float to 2 decimal places.
# Step: Call print() with the right argument(s).
# Example structure: print(f"Pi rounded to 2 decimals: {pi:.2f}")
print(___)  # replace ___ with the correct expression
...
print(f"Pi rounded to 2 decimals: {pi:.2f}")`}
  sct={`test_output_contains("Pi rounded to 2 decimals: 3.14")
success_msg("Number formatting with f-strings works!")`}
  height={120}
/>
