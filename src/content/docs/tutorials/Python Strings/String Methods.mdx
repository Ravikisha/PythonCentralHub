...
## Try it: String Methods Exercises

### Exercise 1 – split() a Sentence

<DataCampExercise
  lang="python"
  hint={`Use .split() to break the sentence into a list of words.`}
  code={`# Task: Exercise 1 – split() a Sentence
...
# Hint: Use .split() to break the sentence into a list of words.
# Step: Assign the correct value to 'words'.
...
# Example structure: print(words)
print(___)  # replace ___ with the correct expression
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print("Word count:", len(words))
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`sentence = "Python is fun"
words = sentence.split()
print(words)
print("Word count:", len(words))`}
  sct={`test_output_contains("Word count: 3")
success_msg("split() works correctly!")`}
  height={150}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use .find() to locate "Python" and .count() to count letter "o".`}
  code={`# Task: Exercise 2 – find() and count()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use .find() to locate "Python" and .count() to count letter "o".
# Step: Call print() with the right argument(s).
# Example structure: print("Position:", text.find("Python"))
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Count of 'o':", text.count("o"))
print(___)  # replace ___ with the correct expression
...
print("Count of 'o':", text.count("o"))`}
  sct={`test_output_contains("Position: 7")
success_msg("find() and count() work!")`}
  height={150}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use .startswith() and .endswith() to check the string boundaries.`}
  code={`# Task: Exercise 3 – startswith() and endswith()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a string) to 'url'.
url = ___  # replace ___ with the correct value
# Hint: Use .startswith() and .endswith() to check the string boundaries.
# Step: Call print() with the right argument(s).
# Example structure: print(url.startswith("https"))
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(url.endswith(".com"))
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`url = "https://pythoncentralhub.com"
print(url.startswith("https"))
print(url.endswith(".com"))`}
  sct={`test_output_contains("True")
success_msg("startswith() and endswith() work!")`}
  height={150}
/>
