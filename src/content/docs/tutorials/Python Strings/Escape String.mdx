...
<DataCampExercise
  lang="python"
  hint={`Use \n for newline and \t for tab in a print statement.`}
  code={`# Task: Exercise 1 – Newline and Tab
...
# Example structure: print("Line 1\\nLine 2")
print(___)  # replace ___ with the correct expression
# Hint: Use \\n for newline and \\t for tab in a print statement.
# Step: Call print() with the right argument(s).
# Example structure: print("Name:\\tAlice")
print(___)  # replace ___ with the correct expression
...
print("Name:\tAlice")`}
  sct={`test_output_contains("Line 1")
test_output_contains("Line 2")
success_msg("Escape characters \\n and \\t work!")`}
  height={130}
/>

### Exercise 2 – Quotes Inside Strings

<DataCampExercise
  lang="python"
  hint={`Use \" to include double quotes inside a double-quoted string.`}
  code={`# Task: Exercise 2 – Quotes Inside Strings
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print("She said, \\"Hello!\\"")
print(___)  # replace ___ with the correct expression
# Hint: Use \\" to include double quotes inside a double-quoted string.
# Step: Call print() with the right argument(s).
# Example structure: print('It\\'s a beautiful day')
print(___)  # replace ___ with the correct expression
...
# ──────────────────────────────────────────────────────────────`}
  solution={`print("She said, \"Hello!\"")
print('It\'s a beautiful day')`}
  sct={`test_output_contains('She said, "Hello!"')
success_msg("Escaped quotes work!")`}
  height={130}
/>

### Exercise 3 – Raw String

<DataCampExercise
  lang="python"
  hint={`Use r"..." to treat backslashes as literal characters.`}
  code={`# Task: Exercise 3 – Raw String
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# ──────────────────────────────────────────────────────────────`}
  solution={`path = r"C:\Users\Alice\Documents"
print(path)`}
  sct={`test_output_contains("C:\\Users\\Alice\\Documents")
success_msg("Raw strings work!")`}
  height={120}
/>
