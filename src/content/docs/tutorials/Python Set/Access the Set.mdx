...
### Exercise 1 – Iterate Over a Set

<DataCampExercise
  lang="python"
  hint={`Use a for loop to iterate over set elements.`}
  code={`# Task: Exercise 1 – Iterate Over a Set
...
# Step: Assign the correct value (a dict or set) to 'animals'.
animals = ___  # replace ___ with the correct value
...
for animal in sorted(animals):
    ...
    # Example structure: print(animal)
...
for animal in sorted(animals):
    print(animal)`}
  sct={`test_output_contains("bird")
success_msg("Set iteration works!")`}
  height={140}
/>

### Exercise 2 – Convert to List

<DataCampExercise
  lang="python"
  hint={`Convert a set to a sorted list to enable index access.`}
  code={`# Task: Exercise 2 – Convert to List
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Step: Call print() with the right argument(s).
# Example structure: print("First:", lst[0])
print(___)  # replace ___ with the correct expression
...
lst = sorted(list(s))
print("First:", lst[0])`}
  sct={`test_output_contains("First: 10")
success_msg("Set to list conversion works!")`}
  height={130}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use sum() on a numeric set.`}
  code={`# Task: Exercise 3 – Set Sum
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a dict or set) to 'nums'.
nums = ___  # replace ___ with the correct value
# Hint: Use sum() on a numeric set.
# Step: Call print() with the right argument(s).
# Example structure: print("Sum:", sum(nums))
print(___)  # replace ___ with the correct expression
...
print("Sum:", sum(nums))`}
  sct={`test_output_contains("Sum: 15")
success_msg("sum() works on sets!")`}
  height={120}
/>
