...
## Try it: Set Operations Exercises
...
<DataCampExercise
  ...
  code={`# Task: Exercise 1 – Union and Intersection
...
print("Intersection:", a & b)`}
  sct={`test_output_contains("Union: 6")
success_msg("Union and intersection work!")`}
  height={150}
/>

### Exercise 2 – Difference

<DataCampExercise
  lang="python"
  hint={`Use - for set difference: elements in a but not in b.`}
  code={`# Task: Exercise 2 – Difference
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
b = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Assign the correct value to 'diff'.
diff = ___  # replace ___ with the correct value
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(sorted(diff))
print(___)  # replace ___ with the correct expression
...
success_msg("Set difference works!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use ^ for elements in either set but not both.`}
  code={`# Task: Exercise 3 – Symmetric Difference
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(sorted(a ^ b))
print(___)  # replace ___ with the correct expression
...
b = {2, 3, 4}
print(sorted(a ^ b))`}
  sct={`test_output_contains("[1, 4]")
success_msg("Symmetric difference works!")`}
  height={130}
/>
