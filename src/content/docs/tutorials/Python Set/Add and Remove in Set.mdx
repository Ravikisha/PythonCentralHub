...
<DataCampExercise
  lang="python"
  hint={`Use .add() to add a single element to a set.`}
  code={`# Task: Exercise 1 – add()
...
# Example structure: print(4 in s)
...
success_msg("add() works!")`}
  height={120}
/>

### Exercise 2 – remove() and discard()

<DataCampExercise
  lang="python"
  hint={`remove() raises KeyError if missing; discard() does not.`}
  code={`# Task: Exercise 2 – remove() and discard()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
success_msg("remove() and discard() work!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use .update() to add multiple elements at once.`}
  code={`# Task: Exercise 3 – update()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
success_msg("update() on set works!")`}
  height={120}
/>
