...
## Try it: Python Set Exercises

### Exercise 1 – Create a Set

<DataCampExercise
  lang="python"
  hint={`Sets are unordered and contain no duplicate elements.`}
  code={`# Task: Exercise 1 – Create a Set
...
# Step: Assign the correct value (a dict or set) to 'fruits'.
fruits = ___  # replace ___ with the correct value
# Hint: Sets are unordered and contain no duplicate elements.
# Step: Call print() with the right argument(s).
# Example structure: print(len(fruits))
...
success_msg("Set creation works!")`}
  height={120}
/>
...
<DataCampExercise
  lang="python"
  hint={`Convert a list with duplicates to a set to remove them.`}
  code={`# Task: Exercise 2 – Remove Duplicates
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Convert a list with duplicates to a set to remove them.
# Step: Assign the correct value to 'unique'.
unique = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(len(unique))
print(___)  # replace ___ with the correct expression
...
success_msg("Set deduplication works!")`}
  height={130}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use the in operator to check if an element is in a set.`}
  code={`# Task: Exercise 3 – Membership Check
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a dict or set) to 'colors'.
colors = ___  # replace ___ with the correct value
# Hint: Use the in operator to check if an element is in a set.
# Step: Call print() with the right argument(s).
# Example structure: print("red" in colors)
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("yellow" in colors)
print(___)  # replace ___ with the correct expression
...
success_msg("Set membership check works!")`}
  height={140}
/>
