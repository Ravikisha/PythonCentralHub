...
## Try it: Python Array Exercises

### Exercise 1 – Create an Array

<DataCampExercise
  lang="python"
  hint={`Import array from the array module, use typecode 'i' for integers.`}
  code={`# Task: Exercise 1 – Create an Array
...
print("Length:", len(nums))`}
  sct={`test_output_contains("Length: 5")
success_msg("Array creation works!")`}
  height={150}
/>

### Exercise 2 – Access and Modify

<DataCampExercise
  lang="python"
  hint={`Use index notation to access and modify array elements.`}
  code={`# Task: Exercise 2 – Access and Modify
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
nums = ___  # replace ___ with the correct value
# Hint: Use index notation to access and modify array elements.
# Step: Assign the correct value (a number) to 'nums[1]'.
nums[1] = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(nums[0], nums[1], nums[2])
print(___)  # replace ___ with the correct expression
...
print(nums[0], nums[1], nums[2])`}
  sct={`test_output_contains("99")
success_msg("Array element modification works!")`}
  height={150}
/>

### Exercise 3 – Iterate Over Array

<DataCampExercise
  lang="python"
  hint={`Use a for loop to iterate over an array.`}
  code={`# Task: Exercise 3 – Iterate Over Array
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
for val in arr:
    # Hint: Use a for loop to iterate over an array.
    # Step: Call print() with the right argument(s).
    # Example structure: print(round(val, 1))
    print(___)  # replace ___ with the correct expression
...
for val in arr:
    print(round(val, 1))`}
  sct={`test_output_contains("1.1")
test_output_contains("3.3")
success_msg("Array iteration works!")`}
  height={150}
/>
