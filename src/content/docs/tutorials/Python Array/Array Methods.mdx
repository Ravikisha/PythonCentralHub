...
## Try it: Array Methods Exercises

### Exercise 1 – index() and count()

<DataCampExercise
  lang="python"
  hint={`Use .index() to find position and .count() to count occurrences.`}
  code={`# Task: Exercise 1 – index() and count()
...
# Step: Assign the correct value to 'arr'.
arr = ___  # replace ___ with the correct value
# Hint: Use .index() to find position and .count() to count occurrences.
# Step: Call print() with the right argument(s).
# Example structure: print("Index of 3:", arr.index(3))
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Count of 2:", arr.count(2))
print(___)  # replace ___ with the correct expression
...
print("Count of 2:", arr.count(2))`}
  sct={`test_output_contains("Index of 3: 2")
test_output_contains("Count of 2: 3")
...
<DataCampExercise
  lang="python"
  hint={`Use .reverse() to reverse the array in-place.`}
  code={`# Task: Exercise 2 – reverse()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(list(arr))
print(___)  # replace ___ with the correct expression
...
arr.reverse()
print(list(arr))`}
  sct={`test_output_contains("[5, 4, 3, 2, 1]")
success_msg("reverse() works!")`}
  height={140}
/>

### Exercise 3 – Convert to List

<DataCampExercise
  lang="python"
  hint={`Use list() or .tolist() to convert an array to a regular list.`}
  code={`# Task: Exercise 3 – Convert to List
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(type(lst).__name__, lst)
print(___)  # replace ___ with the correct expression
...
success_msg("tolist() conversion works!")`}
  height={140}
/>
