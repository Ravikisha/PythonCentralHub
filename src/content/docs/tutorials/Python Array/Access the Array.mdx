...
## Try it: Access Array Exercises

### Exercise 1 – Positive Indexing

<DataCampExercise
  lang="python"
  hint={`Use a positive index to access array elements.`}
  code={`# Task: Exercise 1 – Positive Indexing
...
print(arr[0])
print(arr[2])`}
  sct={`test_output_contains("100")
test_output_contains("300")
success_msg("Array positive indexing works!")`}
  height={150}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use -1 for the last element.`}
  code={`# Task: Exercise 2 – Negative Indexing
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
print(arr[-1])
print(arr[-2])`}
  sct={`test_output_contains("40")
test_output_contains("30")
success_msg("Array negative indexing works!")`}
  height={150}
/>
...
<DataCampExercise
  lang="python"
  hint={`Convert to list or use slicing to get a range.`}
  code={`# Task: Exercise 3 – Slicing
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
arr = ___  # replace ___ with the correct value
# Hint: Convert to list or use slicing to get a range.
# Step: Assign the correct value to 'sub'.
sub = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(list(sub))
print(___)  # replace ___ with the correct expression
...
sub = arr[1:4]
print(list(sub))`}
  sct={`test_output_contains("[2, 3, 4]")
success_msg("Array slicing works!")`}
  height={150}
/>
