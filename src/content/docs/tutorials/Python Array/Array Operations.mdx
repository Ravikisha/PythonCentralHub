...
### Exercise 1 – Concatenate Arrays

<DataCampExercise
  lang="python"
  hint={`Use + to join two arrays of the same type.`}
  code={`# Task: Exercise 1 – Concatenate Arrays
...
# Example structure: print(list(c))
...
success_msg("Array concatenation works!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use the in operator to check if a value exists in the array.`}
  code={`# Task: Exercise 2 – Search in Array
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use the in operator to check if a value exists in the array.
# Step: Call print() with the right argument(s).
# Example structure: print(20 in arr)
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(99 in arr)
print(___)  # replace ___ with the correct expression
...
success_msg("in operator on array works!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use sum() on an array directly.`}
  code={`# Task: Exercise 3 – Sum of Array
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use sum() on an array directly.
# Step: Call print() with the right argument(s).
# Example structure: print("Sum:", sum(arr))
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Max:", max(arr))
print(___)  # replace ___ with the correct expression
...
test_output_contains("Max: 5")
success_msg("sum() and max() on array work!")`}
  height={150}
/>
