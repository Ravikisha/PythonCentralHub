...
### Exercise 1 – append() and insert()

<DataCampExercise
  lang="python"
  hint={`Use .append() to add to end and .insert(index, value) to add at position.`}
  code={`# Task: Exercise 1 – append() and insert()
...
success_msg("append() and insert() work!")`}
  height={150}
/>

### Exercise 2 – remove() and pop()

<DataCampExercise
  lang="python"
  hint={`Use .remove(value) to remove first occurrence, .pop(index) to remove by index.`}
  code={`# Task: Exercise 2 – remove() and pop()
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
arr.pop(2)
print(list(arr))`}
  sct={`test_output_contains("[1, 3, 4]")
success_msg("remove() and pop() work!")`}
  height={150}
/>

### Exercise 3 – Extend Array

<DataCampExercise
  lang="python"
  hint={`Use .extend() to add multiple elements at once.`}
  code={`# Task: Exercise 3 – Extend Array
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
success_msg("extend() on array works!")`}
  height={140}
/>
