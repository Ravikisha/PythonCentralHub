...
print("My favourite language is Python")`}
  sct={`test_output_contains("My name is Alice")
test_output_contains("My favourite language is Python")
success_msg("Printing multiple lines works perfectly!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use f"..." and embed variables like {name} inside the string.`}
  code={`# Task: Exercise 2 – F-String Formatting
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Use f-strings to print a formatted message
# Hint: print(value) displays output; print(a, b) prints multiple values.
...
# Step: Call print() with the right argument(s).
# Example structure: print(f"{name} is {age} years old.")
print(___)  # replace ___ with the correct expression
...
age = 25
print(f"{name} is {age} years old.")`}
  sct={`test_output_contains("Bob is 25 years old.")
success_msg("F-strings make formatting elegant!")`}
  height={150}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use sep="-" to change the separator and end="" to suppress the newline.`}
  code={`# Task: Exercise 3 – Print with sep and end
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Customise separator and end character
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print("Python", "is", "awesome", sep="-")
print(___)  # replace ___ with the correct expression
# Hint: Use sep="-" to change the separator and end="" to suppress the newline.
# Step: Call print() with the right argument(s).
# Example structure: print("Hello", end=" ")
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("World")
print(___)  # replace ___ with the correct expression
...
# World
# ──────────────────────────────────────────────────────────────`}
  solution={`print("Python", "is", "awesome", sep="-")
print("Hello", end=" ")
print("World")`}
  sct={`test_output_contains("Python-is-awesome")
test_output_contains("Hello World")
success_msg("You mastered sep and end parameters!")`}
  height={160}
/>