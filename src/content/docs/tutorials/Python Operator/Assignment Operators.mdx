...
## Try it: Assignment Operators Exercises

### Exercise 1 – Augmented Assignment

<DataCampExercise
  lang="python"
  hint={`Use +=, -=, *=, /= as shorthand for updating variables.`}
  code={`# Task: Exercise 1 – Augmented Assignment
...
success_msg("Augmented assignment works!")`}
  height={140}
/>

### Exercise 2 – Floor Division Assignment

<DataCampExercise
  lang="python"
  hint={`Use //= to perform floor division and assign the result.`}
  code={`# Task: Exercise 2 – Floor Division Assignment
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
n //= 3
print(n)`}
  sct={`test_output_contains("33")
success_msg("//= assignment works!")`}
  height={120}
/>

### Exercise 3 – Modulo Assignment

<DataCampExercise
  lang="python"
  hint={`Use %= to compute modulo and update the variable.`}
  code={`# Task: Exercise 3 – Modulo Assignment
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
