...
## Try it: Bitwise Operators Exercises

### Exercise 1 – AND and OR

<DataCampExercise
  lang="python"
  hint={`& is bitwise AND, | is bitwise OR.`}
  code={`# Task: Exercise 1 – AND and OR
...
# Example structure: print(bin(a & b))
...
print(bin(a & b))
print(bin(a | b))`}
  sct={`test_output_contains("0b1000")
test_output_contains("0b1110")
success_msg("Bitwise AND and OR work!")`}
  height={150}
/>

### Exercise 2 – Left and Right Shift

<DataCampExercise
  lang="python"
  hint={`<< shifts bits left (multiply by 2), >> shifts right (divide by 2).`}
  code={`# Task: Exercise 2 – Left and Right Shift
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
success_msg("Bit shifting works!")`}
  height={130}
/>
...
<DataCampExercise
  lang="python"
  hint={`^ is bitwise XOR. Bits differ → 1, bits same → 0.`}
  code={`# Task: Exercise 3 – XOR
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
b = 0b1100
print(bin(a ^ b))`}
  sct={`test_output_contains("0b110")
success_msg("XOR operator works!")`}
  height={130}
/>
