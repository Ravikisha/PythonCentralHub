...
### Exercise 1 – PEMDAS Order

<DataCampExercise
  lang="python"
  hint={`Parentheses first, then exponent, then * and /, then + and -.`}
  code={`# Task: Exercise 1 – PEMDAS Order
...
# Example structure: print(result)
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Assign the correct value (a tuple or function call) to 'result2'.
result2 = ___  # replace ___ with the correct value
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(result2)
print(___)  # replace ___ with the correct expression

# ── Expected Output ──────────────────────────────────────────
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`result = 2 + 3 * 4
print(result)
result2 = (2 + 3) * 4
print(result2)`}
  sct={`test_output_contains("14")
test_output_contains("20")
success_msg("Operator precedence works!")`}
  height={140}
/>

### Exercise 2 – Mixed Operators

<DataCampExercise
  lang="python"
  hint={`Combine arithmetic and comparison operators carefully.`}
  code={`# Task: Exercise 2 – Mixed Operators
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Combine arithmetic and comparison operators carefully.
# Step: Call print() with the right argument(s).
# Example structure: print(x + 2 > 3 * 2)
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(x ** 2 - 1)
print(___)  # replace ___ with the correct expression
...
success_msg("Mixed operators work!")`}
  height={140}
/>

### Exercise 3 – Use Parentheses

<DataCampExercise
  lang="python"
  hint={`Use parentheses to enforce the order you want.`}
  code={`# Task: Exercise 3 – Use Parentheses
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use parentheses to enforce the order you want.
# Step: Assign the correct value (a tuple or function call) to 'b'.
b = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(a, b)
print(___)  # replace ___ with the correct expression
...
b = (10 - 2) ** 2
print(a, b)`}
  sct={`test_output_contains("6 64")
success_msg("Parentheses change precedence correctly!")`}
  height={130}
/>
