...
## Try it: Identity Operators Exercises

### Exercise 1 – is Operator

<DataCampExercise
  lang="python"
  hint={`is checks if two variables point to the same object in memory.`}
  code={`# Task: Exercise 1 – is Operator
...
# Step: Assign the correct value (a list) to 'c'.
...
# Example structure: print(a is b)
print(___)  # replace ___ with the correct expression
# Step: Call print() with the right argument(s).
# Example structure: print(a is c)
print(___)  # replace ___ with the correct expression
...
<DataCampExercise
  lang="python"
  hint={`is not returns True if two variables are NOT the same object.`}
  code={`# Task: Exercise 2 – is not
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value to 'x'.
...
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(x is None)
print(___)  # replace ___ with the correct expression
# Hint: Read error messages carefully -- they point to the exact line.
# Step: Call print() with the right argument(s).
# Example structure: print(y is not None)
print(___)  # replace ___ with the correct expression
...
print(y is not None)`}
  sct={`test_output_contains("True")
success_msg("is not operator works!")`}
  height={130}
/>

### Exercise 3 – id() Function

<DataCampExercise
  lang="python"
  hint={`Use id() to see the memory address of an object.`}
  code={`# Task: Exercise 3 – id() Function
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a string) to 'a'.
a = ___  # replace ___ with the correct value
# Hint: Use id() to see the memory address of an object.
# Step: Assign the correct value to 'b'.
b = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(id(a) == id(b))
print(___)  # replace ___ with the correct expression
...
print(id(a) == id(b))`}
  sct={`test_output_contains("True")
success_msg("id() identity check works!")`}
  height={130}
/>
