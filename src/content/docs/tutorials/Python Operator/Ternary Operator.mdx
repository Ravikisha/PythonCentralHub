...
<DataCampExercise
  ...
  code={`# Task: Exercise 1 – Basic Ternary
...
# Hint: Syntax: value_if_true if condition else value_if_false
# Step: Assign the correct value (a string) to 'result'.
...
print(result)`}
  sct={`test_output_contains("even")
success_msg("Ternary operator works!")`}
  height={130}
/>

### Exercise 2 – Ternary in print

<DataCampExercise
  lang="python"
  hint={`Use the ternary operator directly inside print().`}
  code={`# Task: Exercise 2 – Ternary in print
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Use the ternary operator directly inside print().
# Step: Call print() with the right argument(s).
# Example structure: print("Adult" if age >= 18 else "Minor")
print(___)  # replace ___ with the correct expression
...
print("Adult" if age >= 18 else "Minor")`}
  sct={`test_output_contains("Adult")
success_msg("Inline ternary works!")`}
  height={110}
/>

### Exercise 3 – Nested Ternary

<DataCampExercise
  lang="python"
  hint={`You can nest ternary operators, but keep it readable.`}
  code={`# Task: Exercise 3 – Nested Ternary
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: You can nest ternary operators, but keep it readable.
# Step: Assign the correct value (a string) to 'grade'.
grade = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(grade)
print(___)  # replace ___ with the correct expression
...
print(grade)`}
  sct={`test_output_contains("C")
success_msg("Nested ternary works!")`}
  height={130}
/>
