...
<DataCampExercise
  ...
  code={`# Task: Exercise 1 – Basic Comparisons
...
success_msg("Relational operators work!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Strings are compared lexicographically (alphabetically).`}
  code={`# Task: Exercise 2 – String Comparison
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print("apple" < "banana")
print(___)  # replace ___ with the correct expression
# Hint: Strings are compared lexicographically (alphabetically).
# Step: Call print() with the right argument(s).
# Example structure: print("Python" == "Python")
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
...
# (Run your completed code to check the output)
# ──────────────────────────────────────────────────────────────`}
  solution={`print("apple" < "banana")
print("Python" == "Python")
print("a" > "b")`}
  sct={`test_output_contains("True")
test_output_contains("False")
success_msg("String comparison works!")`}
  height={140}
/>

### Exercise 3 – Chained Comparisons

<DataCampExercise
  lang="python"
  hint={`Python supports chained comparisons like 1 < x < 10.`}
  code={`# Task: Exercise 3 – Chained Comparisons
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Python supports chained comparisons like 1 < x < 10.
# Step: Call print() with the right argument(s).
# Example structure: print(1 < x < 10)
print(___)  # replace ___ with the correct expression
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(0 <= x <= 5)
print(___)  # replace ___ with the correct expression
...
print(0 <= x <= 5)`}
  sct={`test_output_contains("True")
success_msg("Chained comparisons work!")`}
  height={130}
/>
