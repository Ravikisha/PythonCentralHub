...
<DataCampExercise
  lang="python"
  hint={`Import the operator module and use operator.add(), operator.mul().`}
  code={`# Task: Exercise 1 – operator.add and operator.mul
...
# Example structure: print(operator.add(5, 3))
print(___)  # replace ___ with the correct expression
# Hint: Import the operator module and use operator.add(), operator.mul().
# Step: Call print() with the right argument(s).
# Example structure: print(operator.mul(4, 7))
print(___)  # replace ___ with the correct expression
...
print(operator.mul(4, 7))`}
  sct={`test_output_contains("8")
test_output_contains("28")
success_msg("operator.add() and operator.mul() work!")`}
  height={140}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use operator.lt() for less-than and operator.eq() for equality.`}
  code={`# Task: Exercise 2 – operator.lt and operator.eq
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Call print() with the right argument(s).
# Example structure: print(operator.lt(3, 5))
print(___)  # replace ___ with the correct expression
# Hint: Use operator.lt() for less-than and operator.eq() for equality.
# Step: Call print() with the right argument(s).
# Example structure: print(operator.eq(10, 10))
print(___)  # replace ___ with the correct expression
...
success_msg("operator.lt() and operator.eq() work!")`}
  height={130}
/>

### Exercise 3 – operator.itemgetter

<DataCampExercise
  lang="python"
  hint={`Use operator.itemgetter to sort a list of dicts by a key.`}
  code={`# Task: Exercise 3 – operator.itemgetter
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Above import is provided -- understand what it brings in.
# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a list) to 'data'.
...
# Step: Call print() with the right argument(s).
# Example structure: print(data[0]["name"])
print(___)  # replace ___ with the correct expression
...
success_msg("operator.itemgetter works!")`}
  height={160}
/>
