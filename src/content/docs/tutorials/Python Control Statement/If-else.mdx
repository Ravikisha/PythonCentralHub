...
## Try it: If-else Exercises

### Exercise 1 – Basic If-else

<DataCampExercise
  lang="python"
  hint={`If temperature > 30, print "Hot day!", otherwise print "Nice day!"`}
  code={`# Task: Exercise 1 – Basic If-else
...
# Step: Assign the correct value (a number) to 'temperature'.
temperature = ___  # replace ___ with the correct value

# Hint: print(value) displays output; print(a, b) prints multiple values.
if temperature > 30:
    # Hint: If temperature > 30, print "Hot day!", otherwise print "Nice day!
    # Step: Call print() with the right argument(s).
    # Example structure: print("Hot day!")
...
# Hint: Run after every change -- small steps are easier to debug!
    ...
    # Step: Call print() with the right argument(s).
    # Example structure: print("Nice day!")
    print(___)  # replace ___ with the correct expression
...
if temperature > 30:
    ...
    print("Nice day!")`}
  sct={`test_output_contains("Hot day!")
success_msg("If-else works correctly!")`}
  height={180}
/>
...
<DataCampExercise
  lang="python"
  hint={`Use if/elif/else. Grade >= 90 → A, >= 80 → B, >= 70 → C, else → F.`}
  code={`# Task: Exercise 2 – elif Chain
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Run after every change -- small steps are easier to debug!
    ...
    # Step: Call print() with the right argument(s).
    # Example structure: print("Grade: F")
    print(___)  # replace ___ with the correct expression
...
if score >= 90:
    ...
    print("Grade: F")`}
  sct={`test_output_contains("Grade: C")
success_msg("elif chain works!")`}
  height={220}
/>
...
<DataCampExercise
  lang="python"
  hint={`Syntax: result = value_if_true if condition else value_if_false`}
  code={`# Task: Exercise 3 – Ternary Operator
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Syntax: result = value_if_true if condition else value_if_false
# Step: Assign the correct value (a string) to 'label'.
label = ___  # replace ___ with the correct value
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print(label)
print(___)  # replace ___ with the correct expression
...
print(label)`}
  sct={`test_output_contains("positive")
success_msg("Ternary operator mastered!")`}
  height={140}
/>
