...
## Try it: Pass Statement Exercises

### Exercise 1 – Pass in If Block

<DataCampExercise
  lang="python"
  hint={`Use pass as a placeholder in the if block so Python doesn't error.`}
  code={`# Task: Exercise 1 – Pass in If Block
...
# Example structure: print("Checked x")
...
if x > 5:
    pass
print("Checked x")`}
  sct={`test_output_contains("Checked x")
success_msg("pass in if block works!")`}
  height={150}
/>

### Exercise 2 – Pass as a Function Stub

<DataCampExercise
  lang="python"
  hint={`Define a function greet() using pass so it does nothing yet.`}
  code={`# Task: Exercise 2 – Pass as a Function Stub
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Function defined with pass")
print(___)  # replace ___ with the correct expression
...
print("Function defined with pass")`}
  sct={`test_output_contains("Function defined with pass")
success_msg("Function stub with pass works!")`}
  height={150}
/>

### Exercise 3 – Pass in a Loop

<DataCampExercise
  lang="python"
  hint={`Loop 1 to 5, pass for even numbers, print odd numbers.`}
  code={`# Task: Exercise 3 – Pass in a Loop
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
success_msg("pass in loop works!")`}
  height={170}
/>
