...
## Try it: While Loop Exercises

### Exercise 1 – Basic While Loop

<DataCampExercise
  lang="python"
  hint={`Start count at 1, print while count <= 5, then increment.`}
  code={`# Task: Exercise 1 – Basic While Loop
...
success_msg("While loop runs correctly!")`}
  height={160}
/>

### Exercise 2 – While with Condition

<DataCampExercise
  lang="python"
  hint={`Keep halving the number while it is greater than 1.`}
  code={`# Task: Exercise 2 – While with Condition
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
success_msg("Perfect while loop with condition!")`}
  height={160}
/>

### Exercise 3 – While with break

<DataCampExercise
  lang="python"
  hint={`Use break to exit the loop when the number equals 5.`}
  code={`# Task: Exercise 3 – While with break
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: Update the loop variable inside the while loop to avoid infinite loops!
# Step: Assign the correct value (a number) to 'i'.
...
while True:
    ...
    if i == 5:
        # Hint: Run after every change -- small steps are easier to debug!
        # Step: Call print() with the right argument(s).
        # Example structure: print("Reached 5, stopping!")
        print(___)  # replace ___ with the correct expression
...
while True:
    ...
    if i == 5:
        ...
        break`}
  sct={`test_output_contains("Reached 5, stopping!")
success_msg("break in while loop works!")`}
  height={180}
/>
