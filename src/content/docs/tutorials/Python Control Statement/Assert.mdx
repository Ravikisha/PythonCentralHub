...
## Try it: Assert Statement Exercises

### Exercise 1 – Assert True Condition

<DataCampExercise
  lang="python"
  hint={`Assert that x is positive, then print "All good!".`}
  code={`# Task: Exercise 1 – Assert True Condition
...
# Example structure: print("All good!")
...
assert x > 0
print("All good!")`}
  sct={`test_output_contains("All good!")
success_msg("assert with true condition works!")`}
  height={130}
/>

### Exercise 2 – Assert with Message

<DataCampExercise
  lang="python"
  hint={`Use assert with a custom error message to validate the age.`}
  code={`# Task: Exercise 2 – Assert with Message
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Access granted")
print(___)  # replace ___ with the correct expression
...
print("Access granted")`}
  sct={`test_output_contains("Access granted")
success_msg("assert with message works!")`}
  height={130}
/>

### Exercise 3 – Assert on List Length

<DataCampExercise
  lang="python"
  hint={`Assert the list has exactly 3 elements, then print its length.`}
  code={`# Task: Exercise 3 – Assert on List Length
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!
...
# Hint: Assert the list has exactly 3 elements, then print its length.
# Step: Write the required code here.
# assert len(items) == 3, "List must have 3 items"
# replace the comment above with working code
# Hint: Run after every change -- small steps are easier to debug!
# Step: Call print() with the right argument(s).
# Example structure: print("Length:", len(items))
print(___)  # replace ___ with the correct expression
...
success_msg("assert on list length works!")`}
  height={130}
/>
