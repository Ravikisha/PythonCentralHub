...
## Try it: Match Case Exercises

### Exercise 1 – Match a String

<DataCampExercise
  lang="python"
  hint={`Use match/case to check the day and print whether it's a weekday or weekend.`}
  code={`# Task: Exercise 1 – Match a String
...
# Step: Assign the correct value (a string) to 'day'.
day = ___  # replace ___ with the correct value
...
# replace the comment above with working code
    ...
    # replace the comment above with working code
        ...
        # Example structure: print("Weekend!")
        print(___)  # replace ___ with the correct expression
    # Step: Write the required code here.
    # case _:
    # replace the comment above with working code
        # Step: Call print() with the right argument(s).
        # Example structure: print("Weekday")
        print(___)  # replace ___ with the correct expression
...
match day:
    ...
    case _:
        print("Weekday")`}
  sct={`test_output_contains("Weekend!")
success_msg("match case for strings works!")`}
  height={180}
/>

### Exercise 2 – Match an Integer

<DataCampExercise
  lang="python"
  hint={`Use match/case with 1 → "one", 2 → "two", _ → "other".`}
  code={`# Task: Exercise 2 – Match an Integer
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a number) to 'num'.
num = ___  # replace ___ with the correct value
...
match num:
    ...
    case _:
        print("other")`}
  sct={`test_output_contains("two")
success_msg("match case with integers works!")`}
  height={190}
/>

### Exercise 3 – Match with Default

<DataCampExercise
  lang="python"
  hint={`Match HTTP status: 200 → OK, 404 → Not Found, _ → Unknown.`}
  code={`# Task: Exercise 3 – Match with Default
# Follow the steps below and fill in the blanks.
# Use the 'Show Solution' button only after you have tried!

# Hint: print(value) displays output; print(a, b) prints multiple values.
# Step: Assign the correct value (a number) to 'status'.
status = ___  # replace ___ with the correct value
...
# replace the comment above with working code
    ...
    # replace the comment above with working code
        # Step: Call print() with the right argument(s).
        # Example structure: print("Not Found")
        print(___)  # replace ___ with the correct expression
    # Hint: Read error messages carefully -- they point to the exact line.
    # Step: Write the required code here.
    # case _:
    # replace the comment above with working code
        # Step: Call print() with the right argument(s).
        # Example structure: print("Unknown status")
        print(___)  # replace ___ with the correct expression
...
match status:
  ...
  sct={`test_output_contains("Not Found")
success_msg("Default case in match works!")`}
  height={190}
/>
